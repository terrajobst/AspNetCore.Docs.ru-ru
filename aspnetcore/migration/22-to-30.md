...
В версии 3.0 сценарий согласием не компиляции во время выполнения. Чтобы включить компиляцию среды выполнения, см. в разделе https://docs.microsoft.com/aspnet/core/mvc/views/view-compilation?view=aspnetcore-3.0#runtime-compilation.
