...
#### <a name="framework-dependent-builds-using-docker"></a>Зависимые от платформы сборки с помощью DOCKER

Зависимые от платформы сборки консольных приложений, которые используют пакет, зависящий от ASP.NET Core [общей платформы](https://natemcmaster.com/blog/2018/08/29/netcore-primitives-2/) , могут привести к следующей ошибке выполнения:
...
## <a name="mysqldataentityframeworkcore-currently-not-supported-on-aspnet-core-30"></a>MySql. Data. EntityFrameworkCore в настоящее время не поддерживается в ASP.NET Core 3,0
