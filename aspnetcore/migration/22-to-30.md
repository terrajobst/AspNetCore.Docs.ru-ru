...
* Платформа MVC `Newtonsoft.Json` поддерживает &ndash; поддержка использования MVC с `Newtonsoft.Json` теперь является частью [Microsoft. AspNetCore. MVC. невтонсофтжсон](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.NewtonsoftJson).
...
### <a name="systemruntimeserialization-attributes-not-supported"></a>Атрибуты System. Runtime. Serialization не поддерживаются

Атрибуты [[DataContract]](xref:System.Runtime.Serialization.DataContractAttribute) и [[DataMember]](xref:System.Runtime.Serialization.DataMemberAttribute) не поддерживаются в `System.Text.Json`. Дополнительные сведения см. в статье о [поддержке системы GitHub System. Text. JSON в System. Runtime. Serialization](https://github.com/dotnet/corefx/issues/38758).
