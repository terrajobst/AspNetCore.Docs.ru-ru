...
Проекты, предназначенные для .NET Core должны использовать [TFM](/dotnet/standard/frameworks) версии не меньше .NET Core 2.2. В файле проекта, обновите `<TargetFramework>` внутренний текст узла с `netcoreapp2.2`:
