<span data-ttu-id="7cfc3-101">Запустите scaffolder удостоверений:</span><span class="sxs-lookup"><span data-stu-id="7cfc3-101">Run the Identity scaffolder:</span></span>
