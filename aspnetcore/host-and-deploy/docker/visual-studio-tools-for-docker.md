...
[Visual Studio 2017](https://www.visualstudio.com/) поддерживает создание, отладку и запуск приложений ASP.NET Core, предназначенных для .NET Framework или .NET Core. Поддерживаются контейнеры Windows и Linux.
