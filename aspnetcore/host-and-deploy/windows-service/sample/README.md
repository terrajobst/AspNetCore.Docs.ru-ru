# <a name="custom-webhost-service-sample"></a><span data-ttu-id="652c7-101">Пример пользовательской службы WebHost</span><span class="sxs-lookup"><span data-stu-id="652c7-101">Custom WebHost Service Sample</span></span>
