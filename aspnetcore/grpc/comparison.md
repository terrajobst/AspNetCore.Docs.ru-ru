...
* **Микрослужбы** &ndash; gRPC является спроектированный низкой задержкой и высокой пропускной способности связи. gRPC отлично подходит для микрослужбы упрощенных где важна эффективность.
