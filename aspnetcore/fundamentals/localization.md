...
### <a name="configuring-localization"></a>Настройка локализации
...
### <a name="setting-the-accept-language-http-header-in-ie"></a>Задание заголовка HTTP Accept-Language в IE
...
### <a name="using-a-custom-provider"></a>С помощью пользовательского поставщика
...
### <a name="setting-the-culture-programmatically"></a>Программная установка языка и региональных параметров
