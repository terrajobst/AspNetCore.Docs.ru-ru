...
Чтобы создать журналы, примените объект [ILogger](/dotnet/api/microsoft.extensions.logging.ilogger) из контейнера [внедрения зависимостей](xref:fundamentals/dependency-injection).
