...
Веб-сервер Kestrel получил новые функции, необходимые серверу с выходом в Интернет. Добавлено несколько параметров конфигурации ограничений для сервера в новое свойство `KestrelServerOptions` класса `Limits`. Вы можете добавлять следующие ограничения:
...
* [Как настроить приложение службы приложений для использования имени для входа Facebook](xref:security/authentication/facebook-logins)
* [Как настроить приложение службы приложений для использования имени для входа Twitter](xref:security/authentication/twitter-logins)
* [Как настроить приложение службы приложений для использования имени для входа Google](xref:security/authentication/google-logins)
