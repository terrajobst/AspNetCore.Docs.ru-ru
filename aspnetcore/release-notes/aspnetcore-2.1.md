...
## <a name="generic-host-builder"></a>Строитель универсальных узлов

Добавлен строитель универсальных узлов (`HostBuilder`). Строитель можно использовать для приложений, которые не обрабатывают HTTP-запросы (обмен сообщениями, фоновые задачи и т. д.).
