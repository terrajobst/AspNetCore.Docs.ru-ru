...
---
# <a name="use-gulp-in-aspnet-core"></a>Использование Gulp в ASP.NET Core
...
4.  В **Task Runner Explorer**, щелкните правой кнопкой мыши **первый**и выберите **запуска**.
    ...
    Выходной текст отображается. Примеры, основываясь на общих сценариях см [Gulp рецепты](#gulp-recipes).
...
Дополнительные сведения, относящиеся к средам в ASP.NET Core см. в разделе [работать с несколькими средами](../fundamentals/environments.md).
...
* [Использовать Grunt в ASP.NET Core](using-grunt.md)
