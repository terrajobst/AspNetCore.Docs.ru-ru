...
* Используйте `DbSet.FromSql` метод для запросов, возвращающих типы сущностей. Возвращаемые объекты должно относится к типу, ожидаемому `DbSet` объекта и они автоматически отслеживаются контекстом базы данных пока не вы [отключить отслеживание](crud.md#no-tracking-queries).
...
Исходный код для Entity Framework Core доступен на [https://github.com/aspnet/EntityFramework](https://github.com/aspnet/EntityFramework). Помимо исходного кода, можно получить Ночные построения, отслеживанием, компонент спецификаций, заметки собрания разработчика [стратегия для будущих разработок](https://github.com/aspnet/EntityFramework/wiki/Roadmap)и многое другое. Можно регистрировать ошибки и могут способствовать собственные усовершенствования EF исходного кода.
