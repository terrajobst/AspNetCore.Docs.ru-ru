...
| ограничение серверного приложения Blazor                            | Описание | Значение по умолчанию |
| ------------------------------------------------------- | ----------- | ------- |
...
* Раздел конфигурации (тип `DetailedErrors`). Например, задайте для переменной среды `ASPNETCORE_DETAILEDERRORS` значение `true`.
