...
| Ограничение серверного приложения блазор                            | Description | По умолчанию |
| ------------------------------------------------------- | ----------- | ------- |
...
| Ограничение SignalR и ASP.NET Core             | Description | По умолчанию |
| ------------------------------------------ | ----------- | ------- |
...
* Все вызовы имеют настраиваемое время ожидания, после которого они завершаются сбоем, возвращая <xref:System.OperationCanceledException> вызывающему.
  * Время ожидания вызовов (`CircuitOptions.JSInteropDefaultCallTimeout`) по умолчанию — одна минута. Чтобы настроить это ограничение, см. раздел <xref:blazor/call-javascript-from-dotnet#harden-js-interop-calls>.
