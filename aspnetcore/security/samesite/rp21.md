...
---
# <a name="aspnet-core-21-razor-pages-samesite-cookie-sample"></a>Пример файла cookie ASP.NET Core 2,1 Razor Pages SameSite
...
В приведенном выше коде проверка подлинности файлов cookie и состояние сеанса устанавливают атрибут sameSite в значение `None`, выдает атрибут со значением `None`, а также устанавливает безопасный атрибут в `true`.

### <a name="run-the-sample"></a>Запуск примера

При запуске [примера проекта](https://github.com/blowdart/AspNetSameSiteSamples/tree/master/AspNetCore21RazorPages)Загрузите отладчик браузера на начальной странице и используйте его для просмотра коллекции файлов cookie для сайта. Чтобы сделать это на границе и Chrome, нажмите кнопку `F12` затем выберите вкладку `Application` и щелкните URL-адрес сайта в параметре `Cookies` в разделе `Storage`.
