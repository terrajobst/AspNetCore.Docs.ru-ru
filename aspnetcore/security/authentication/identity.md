...
Вы можете настроить в ASP.NET Identity Core использование базы данных SQL Server для хранения пользовательских имен, паролей и данных профиля. Помимо этого, вы можете использовать собственные постоянные хранилища, например хранилище таблиц Azure. Этот документ содержит инструкции по использованию Visual Studio и CLI. 
