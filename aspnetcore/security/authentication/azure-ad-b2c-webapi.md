...
| **URI ИД приложения**                | *api*               | URI не нужно преобразовать физический адрес. Он должен быть уникальным.     |
...
### <a name="test-the-web-api-withoutauthentication"></a>Тестирование withoutauthentication веб-API
...
2. Завершить **получить новый ТОКЕН доступа** диалоговое окно следующим образом:
    ...
    | Параметр                   | Значение                                                                                         | Примечания                                                                                      |
    |---------------------------|-----------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
    | **Имя токена**            | *&lt;Имя токена&gt;*                                                                          | Введите описательное имя для маркера.                                                    |
    | **Тип предоставления**            | Неявные                                                                                      |                                                                                            |
