...
Параметр проверки подлинности был добавлен к шаблонам проектов " **угловой** " и " **отреагировать** ", похожим на параметр проверки подлинности в шаблонах проектов **веб-приложения (модель-представление-контроллер)** (MVC) и **веб-приложение** (Razor Pages). Допустимые значения параметра: **None** и **индивидуальных**. Шаблон проекта **реагируют. js и Redux** в настоящее время не поддерживает параметр проверки подлинности.
