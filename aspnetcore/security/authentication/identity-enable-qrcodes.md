...
---
# <a name="enable-qr-code-generation-for-totp-authenticator-apps-in-aspnet-core"></a>Включить создание QR-код для TOTP приложения для проверки подлинности в ASP.NET Core
