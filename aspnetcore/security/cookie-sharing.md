...
---
# <a name="sharing-cookies-among-apps-with-aspnet-and-aspnet-core"></a>Совместное использование файлов cookie между приложениями с помощью ASP.NET и ASP.NET Core
