...
<span data-ttu-id="178b4-134">При использовании удостоверения ASP.NET Core:</span><span class="sxs-lookup"><span data-stu-id="178b4-134">When using ASP.NET Core Identity:</span></span>
