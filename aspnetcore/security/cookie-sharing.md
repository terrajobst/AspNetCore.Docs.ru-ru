...
<span data-ttu-id="0fc76-134">При использовании удостоверения ASP.NET Core:</span><span class="sxs-lookup"><span data-stu-id="0fc76-134">When using ASP.NET Core Identity:</span></span>
