...
* *Pages/Privacy.cshtml* страницы или *Views/Home/Privacy.cshtml* представление будет содержать подробные сведения о политике конфиденциальности веб сайта страницы.

Для включения функции согласия файла cookie по умолчанию, см. в шаблонах ASP.NET Core 2.2 в шаблон, создаваемый в приложении ASP.NET Core 3.0:

* Добавить [CookiePolicyOptions](/dotnet/api/microsoft.aspnetcore.builder.cookiepolicyoptions) слишком `Startup.ConfigureServices` и [UseCookiePolicy](/dotnet/api/microsoft.aspnetcore.builder.cookiepolicyappbuilderextensions.usecookiepolicy) для `Startup.Configure`:

  [!code-csharp[Main](gdpr/sample/RP3.0/Startup.cs?name=snippet1&highlight=12-19,38)]

* Добавление разделяемого согласия файл cookie для *_Layout.cshtml* файла:

  [!code-cshtml[Main](gdpr/sample/RP3.0/Pages/Shared/_Layout.cshtml?name=snippet&highlight=4)]

* Добавить  *\_CookieConsentPartial.cshtml* файл в проект:

  [!code-cshtml[Main](gdpr/sample/RP3.0/Pages/Shared/_CookieConsentPartial.cshtml)]

* Выберите версию ASP.NET Core 2.2 эту статью, чтобы узнать об функции разрешения файлов cookie.
