...
Вместо этого мы используем Формирования NIST SP800-108 в режиме счетчика (см. [NIST SP800-108](http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-108.pdf), сек. 5.1) с ключом нулевой длины, метку и контекст и HMACSHA512 как базовый PRF. Мы производные | K_E | + | K_H | байт выходных данных, затем разложения результат K_E и K_H сами. Математически она представлена следующим образом.
