...
С этими правилами, помните, мы разработали простой, [удобные](xref:security/data-protection/using-data-protection) стека защиты данных.
...
1. [Обзор API-интерфейсы потребителя](xref:security/data-protection/consumer-apis/overview) целевой разработчики приложений и инфраструктуры.
...
2. [Интерфейсы API настройки](xref:security/data-protection/configuration/overview) предназначены для разработчиков приложений и системных администраторов.
