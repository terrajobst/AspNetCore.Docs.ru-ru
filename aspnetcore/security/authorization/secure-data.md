...
| Пользовательская                | Seeded by the app | Параметры                                  |
| ------------------- | :---------------: | ---------------------------------------- |
| test@example.com    | Нет                | Edit/delete the own data.                |
| manager@contoso.com | Да               | Approve/reject and edit/delete own data. |
| admin@contoso.com   | Да               | Approve/reject and edit/delete all data. |
