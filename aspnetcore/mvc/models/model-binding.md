...
2. `Route values`: Набор значений маршрута, предоставляемые [маршрутизации](xref:fundamentals/routing)
...
## <a name="bind-formatted-data-from-the-request-body"></a>Привязать форматированные данные из текста запроса
