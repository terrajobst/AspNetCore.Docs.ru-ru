...
Платформа поддерживает согласования содержимого HTTP со встроенной поддержкой [форматирования данных](models/formatting.md) в виде JSON или XML. Пишите [пользовательские модули форматирования](advanced/custom-formatters.md) для добавления поддержки собственных форматов.
