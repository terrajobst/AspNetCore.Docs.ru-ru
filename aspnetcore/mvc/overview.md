...
> [!NOTE]
> Контроллеры не должно быть слишком осложняется слишком много обязанности. Чтобы становились логику контроллера слишком сложным, используйте [персональной ответственности](http://deviq.com/single-responsibility-principle/) к бизнес-логике push из контроллера и в модели домена.
