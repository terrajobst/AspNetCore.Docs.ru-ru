...
Директива `@namespace` задает пространство имен класса созданной страницы или представления:

```cshtml
@namespace Your.Namespace.Here
```

Если страница или представление импортирует API с помощью директивы `@namespace`, пространство имен исходного файла задается относительно этого пространства имен. 

Если *MyApp/Pages/\_ViewImports.cshtml* содержит `@namespace Hello.World`, пространство имен страниц или представлений, которые импортируют пространство имен `Hello.World`, задается, как показано в следующей таблице.

| Страница (или представление)                     | Пространство имен               |
| ---------------------------------- | ----------------------- |
| *MyApp/Pages/Index.cshtml*         | `Hello.World`           |
| *MyApp/Pages/MorePages/Bar.cshtml* | `Hello.World.MorePages` |

Если у нескольких файлов импорта есть директива `@namespace`, используется файл, ближайший к странице или представлению в цепочке каталога.

### <a name="section"></a>@section

Директива `@section` используется в сочетании с [макетом](xref:mvc/views/layout) и позволяет страницам или представлениям отображать содержимое в различных частях HTML-страницы. Дополнительные сведения: [Разделы](xref:mvc/views/layout#layout-sections-label).
