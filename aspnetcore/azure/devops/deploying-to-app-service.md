...
> *Примечание. Пользователи Linux и macOS должны внести соответствующие изменения в пути, например, используя косую черту`/`(), а не обратную косую черту (`\`).*
...
1. Войдите в [Azure Cloud Shell](https://shell.azure.com/bash). Примечание. При первом входе Cloud Shell запрос на создание учетной записи хранения для файлов конфигурации. Примите значения по умолчанию или задайте уникальное имя.
