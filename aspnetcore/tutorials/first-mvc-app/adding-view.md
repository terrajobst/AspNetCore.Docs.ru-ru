...
* В элементе title измените `MvcMovie` на `Movie App`.
...
Сохраните изменения и нажмите на ссылку **Конфиденциальность**. Обратите внимание, что заголовок вкладки браузера изменяется на **Конфиденциальность — Movie App** вместо **Конфиденциальность — Mvc Movie**:
