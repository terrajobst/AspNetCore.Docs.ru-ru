...
<span data-ttu-id="d90c0-103">[Предыдущая тема: работа с SQLlite](xref:tutorials/razor-pages-mac/sql)
[Добавление поиска](xref:tutorials/razor-pages-mac/search)</span><span class="sxs-lookup"><span data-stu-id="d90c0-103">[Previous: Working with SQLlite](xref:tutorials/razor-pages-mac/sql)
