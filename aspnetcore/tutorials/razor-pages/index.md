...
keywords: "ASP.NET Core,Razor Pages,формирование,Entity Framework Core,EF,EF Core,база данных"
ms.author: riande
manager: wpickett
ms.date: 09/08/2017
...
В этой серии статей приводятся основные сведения о создании веб-приложения Razor Pages с помощью ASP.NET Core и Visual Studio. Версию для Mac см. [здесь](xref:tutorials/razor-pages-mac/index). Версию для Visual Studio Code см. [здесь](xref:tutorials/razor-pages-vsc/index).
