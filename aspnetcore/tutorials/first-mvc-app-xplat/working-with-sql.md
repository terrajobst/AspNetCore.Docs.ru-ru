...
<span data-ttu-id="1cab4-104">[Предыдущая статья — "Добавление модели"](adding-model.md)
[Следующая статья — "Методы и представления контроллера"](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="1cab4-104">[Previous - Add a model](adding-model.md)
