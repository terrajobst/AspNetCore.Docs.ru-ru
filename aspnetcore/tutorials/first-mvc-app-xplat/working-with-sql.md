...
<span data-ttu-id="8f9d6-103">[Предыдущая статья — "Добавление модели"](adding-model.md)
[Следующая статья — "Методы и представления контроллера"](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="8f9d6-103">[Previous - Add a model](adding-model.md)
