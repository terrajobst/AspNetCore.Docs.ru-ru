...
---
# <a name="add-a-model-to-an-aspnet-core-mvc-app-with-visual-studio-for-mac"></a>Добавление модели в приложение ASP.NET Core MVC с помощью Visual Studio для Mac
