...
<span data-ttu-id="36960-103">[Предыдущая статья — "Добавление поля"](new-field.md)
[Следующая статья — "Изучение методов Details и Delete"](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="36960-103">[Previous - Add a field](new-field.md)
