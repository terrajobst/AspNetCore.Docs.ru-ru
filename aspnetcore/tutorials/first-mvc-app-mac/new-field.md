...
<span data-ttu-id="dc3ca-104">[Предыдущая статья — "Добавление поиска"](search.md)
[Следующая статья — "Добавление проверки"](validation.md)</span><span class="sxs-lookup"><span data-stu-id="dc3ca-104">[Previous - Add search](search.md)
