...
* Внедрить абстракцию `IJSRuntime` и использовать внедренный объект для вызова взаимодействия JS.
...
Используйте `IJSRuntime.InvokeAsync<T>` и вызовите `exampleJsFunctions.focusElement` с `ElementReference`, чтобы сосредоточиться на элементе:

[!code-cshtml[](javascript-interop/samples_snapshot/component1.razor?highlight=1,3,11-12)]

Чтобы использовать метод расширения для фокусировки элемента, создайте статический метод расширения, который получает экземпляр `IJSRuntime`:
