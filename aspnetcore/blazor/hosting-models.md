...
Приложение ASP.NET Core ссылается на класс @no__t приложения для добавления:

* Службы на стороне сервера.
* Приложение в конвейер обработки запросов.

Сценарий *блазор. Server. js* @ no__t-1 устанавливает клиентское соединение. Ответственность за сохранение и восстановление состояния приложения в случае необходимости (например, в случае потери сетевого подключения) несет приложение.
