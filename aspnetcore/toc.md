...
## [Использование шаблонов проектов для одностраничных приложений (предварительная версия)](xref:spa/index)
...
### [Добавление функций приложения из внешней сборки с помощью IHostingStartup](xref:hosting/ihostingstartup)
