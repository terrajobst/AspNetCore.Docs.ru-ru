...
**Не Выменяйте это:** В следующем примере используется `async void`, после достижения которого HTTP-запрос завершается при достижении первого @no__t.
