...
1. В обозревателе решений щелкните правой кнопкой мыши проект &gt; **управление пакетами NuGet**. В поле поиска введите «Asp.net Identity». Выберите пакет в списке результатов и нажмите "установить". Примите лицензионное соглашение, нажав кнопку «Принимаю». Обратите внимание, что этот пакет устанавливается пакеты зависимостей: EntityFramework и Microsoft ASP.NET Identity Core. Аналогичным образом установите следующие пакеты (пропустить последние 4 пакеты OWIN, если вы не хотите включить вход OAuth):
