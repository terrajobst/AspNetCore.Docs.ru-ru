...
3. Разрешить использование поставщиков профиль по умолчанию в *web.config* файла и определения класса, объявленного в шаге &#2; для использования в доступе к сведениям профиля.
