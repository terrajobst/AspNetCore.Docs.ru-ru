Доступна обновленная версия этого учебника [здесь](https://docs.microsoft.com/aspnet/core/tutorials/first-mvc-app/start-mvc) с использованием последней версии [Visual Studio.](https://www.visualstudio.com) Новое в этом учебнике используется [ASP.NET Core MVC](https://docs.microsoft.com/aspnet/core/mvc/), предоставляющее **много** усовершенствования, внесенные через этого учебника.
