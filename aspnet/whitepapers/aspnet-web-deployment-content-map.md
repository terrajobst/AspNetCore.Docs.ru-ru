...
- [Обзор развертывания веб-для Visual Studio и ASP.NET](https://msdn.microsoft.com/library/dd394698.aspx) (MSDN).
...
- [Как: развертывание, публикация веб-проекта с помощью одного щелчка мыши в Visual Studio](https://msdn.microsoft.com/library/dd465337.aspx) (ссылаться информации для мастера веб-публикации Visual Studio).
...
- [Как: создайте пакет веб-развертывания в Visual Studio](https://msdn.microsoft.com/library/dd465323.aspx) (MSDN).
- [Способ: установите создан пакет развертывания, с помощью файла deploy.cmd, Visual Studio](https://msdn.microsoft.com/library/ff356104.aspx) (MSDN).
...
- [Отключение преобразования Web.config](https://msdn.microsoft.com/library/ee942158.aspx#disable_web_config_transformation) (MSDN).
...
- [Как: использование веб-развертывания параметров в пакет веб-развертывания](https://msdn.microsoft.com/library/ff398068.aspx) (MSDN).
...
- [Настройка развертывания базы данных в Visual Studio](https://msdn.microsoft.com/library/dd394698.aspx#dbdeployment) (MSDN). Общие сведения о параметрах развертывания базы данных с веб-проекта.
...
- [Как: развертывание веб-проекта с помощью одного щелчка мыши публикации в Visual Studio](https://msdn.microsoft.com/library/dd465337.aspx) (MSDN).
...
- [Миграция баз данных в базу данных SQL Windows Azure (прежнее название — SQL Azure)](https://msdn.microsoft.com/library/windowsazure/ee730904.aspx) (MSDN).
...
- [Вкладка "веб" упаковки и публикации, свойства проекта](https://msdn.microsoft.com/library/dd410108.aspx) (MSDN).
- [Дополнительные параметры предварительной компиляции](https://msdn.microsoft.com/library/hh475319.aspx) (MSDN).
...
- [Создание сайта интрасети с помощью ASP.NET MVC](https://msdn.microsoft.com/library/gg703322(VS.98).aspx) (MSDN). Более старые writen пошагового руководства для Visual Studio 2010 не отражает значительных изменений в шаблоны проектов интрасети, представленные в Visual Studio 2013.
