...
.NET Framework 4.5 и Windows 8 представлены функции, которые могут помочь вам в достижении увеличению производительности односекционных рабочие нагрузки веб сервера. Сюда входят сокращение (до 35%) в обоих время запуска и объем памяти для размещения сайтов, использующих ASP.NET веб-сайтов.
...
Вы можете теперь HTML-кодирование результат выражения привязки данных. Добавьте двоеточие (:) и заканчивая &lt;префикс % #, который помечает выражения привязки данных:
