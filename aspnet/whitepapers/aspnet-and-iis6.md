...
Чтобы запустить мастер - примечание, чтобы запустить мастер, необходимо войти качестве администратора - перейдите к: запуск | Программы | Администрирование и выберите «настройки сервера».
