...
Теперь будет отправлена ошибки размещения и URL-адрес http://<em>данный сайт</em>/ достигнет рабочего стола домашней страницы и http://<em>данный сайт</em>/mobile/ достигнет мобильных домашней страницы.
