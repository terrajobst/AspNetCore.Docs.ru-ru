...
---
<a name="aspnet-mvc-storefront-part-3-pipes-and-filters"></a>Storefront часть ASP.NET MVC 3: Каналы и фильтры
====================
по [ток Conery](https://github.com/robconery)

Вадим Conery рассматриваются отзыв части 1 и 2, затем погружение в реализации каналов и фильтры в репозитории IQueryable.

[&#9654;Посмотрите видео (16 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-mvc-storefront-part-3-pipes-and-filters)
