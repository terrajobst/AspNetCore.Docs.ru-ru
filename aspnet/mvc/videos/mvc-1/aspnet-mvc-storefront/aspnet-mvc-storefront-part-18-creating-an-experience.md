...
---
<a name="aspnet-mvc-storefront-part-18-creating-an-experience"></a>ASP.NET MVC Storefront часть 18: Создает интерфейс
====================
по [ток Conery](https://github.com/robconery)

В этой серии я работаю над извлекать все технические компоненты вместе для формирования согласованного «настройки» покупатель.

[&#9654;Посмотрите видео (в минутах 21)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-mvc-storefront-part-18-creating-an-experience)
