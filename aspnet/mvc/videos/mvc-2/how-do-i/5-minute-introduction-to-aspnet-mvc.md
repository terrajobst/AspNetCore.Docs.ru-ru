...
---
<a name="5-minute-introduction-to-aspnet-mvc"></a>5-минутного введение в ASP.NET MVC
====================
по [Скотт Хансельман](https://github.com/shanselman)

Скотт Хансельман представляется 5-минутного введение в ASP.NET MVC.

[&#9654;Посмотрите видео (8 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/5-minute-introduction-to-aspnet-mvc)
