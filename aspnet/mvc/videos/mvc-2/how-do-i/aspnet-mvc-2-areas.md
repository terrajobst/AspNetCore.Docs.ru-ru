...
---
<a name="aspnet-mvc-2---areas"></a>ASP.NET MVC 2 - областей
====================
по [Джон Гэллоуэй](https://github.com/jongalloway)

В этом видео вы узнаете, как использовать функцию области для упрощения организации крупных приложений ASP.NET MVC, разбив их на разных функциональных областях.

[&#9654; Посмотрите видео (3 минуты)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-mvc-2-areas)
