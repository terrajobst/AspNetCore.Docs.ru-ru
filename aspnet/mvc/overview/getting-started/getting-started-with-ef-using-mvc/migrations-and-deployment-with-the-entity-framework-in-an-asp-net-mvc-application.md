...
---
<a name="code-first-migrations-and-deployment-with-the-entity-framework-in-an-aspnet-mvc-application"></a>Код первой миграции и развертывания с помощью Entity Framework в приложении ASP.NET MVC
====================
...
В этом руководстве вы узнали, как включить перенос и развертывание приложения. В следующем руководстве вы начнете рассматривать более сложные вопросы, развернув модель данных.
