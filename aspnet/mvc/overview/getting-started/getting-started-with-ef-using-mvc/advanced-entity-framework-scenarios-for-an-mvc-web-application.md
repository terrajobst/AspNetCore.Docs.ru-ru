...
> [!div class="checklist"]
> * Выполняйте необработанные SQL-запросы
...
## <a name="perform-raw-sql-queries"></a>Выполняйте необработанные SQL-запросы
...
## <a name="create-an-abstraction-layer"></a>Создать уровень абстракции
...
> [!div class="checklist"]
> * Выполнить необработанные SQL-запросы
