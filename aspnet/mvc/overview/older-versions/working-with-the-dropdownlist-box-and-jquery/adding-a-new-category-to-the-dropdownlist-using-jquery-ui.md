...
[Html.BeginForm](https://msdn.microsoft.com/en-us/library/dd492714.aspx) вспомогательный перегруженный метод, используемый в *Views\Genre\\_CreateGenre.cshtml* файл создает HTML-код с атрибутом действий, содержащую URL-адрес для отправки формы. Это можно увидеть, отображение страницы создания альбом в браузере и выбрав источник Показать в браузере. В следующем примере показана созданного кода HTML, содержащий тег формы.
