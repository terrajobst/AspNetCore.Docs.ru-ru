...
---
<a name="examining--how--aspnet-mvc-scaffolds-the-dropdownlist-helper"></a>Проверка того, как ASP.NET MVC формирует шаблоны вспомогательного метода DropDownList
====================
