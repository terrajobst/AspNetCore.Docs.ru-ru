...
| **Папка** | **Назначение** |
| --- | --- |
| **/ Контроллеры** | Контроллеры реагировать на ввод из браузера, решить, что с ним делать и возвращает его пользователю. |
| **И представления** | Представления содержат наши шаблоны пользовательского интерфейса |
| **И моделей** | Модели хранения и управления данными |
| **/ Содержимого** | Эта папка содержит нашей изображений, CSS и статическое содержимое |
| **/ Сценарии** | Эта папка содержит файлы нашей JavaScript |
