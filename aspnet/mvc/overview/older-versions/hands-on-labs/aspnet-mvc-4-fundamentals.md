...
- **Контроллеры:** контроллеров служат для управления взаимодействием с пользователем, управлять модели и выбора представления для отображения пользовательского интерфейса. В приложении MVC представление служит только для отображения информации. Обработку введенных данных, формирование ответа и взаимодействие с пользователем обеспечивает контроллер.
...
7. [Упражнение 7: Краткая информация о новый шаблон ASP.NET MVC 4](#Exercise7)
...
5. Включить div для его отображения текста каждой страницы. Замените  <strong>@RenderBody()</strong> следующим кодом higlighted: (C#)
...
### <a name="exercise-7-a-lap-around-aspnet-mvc-4-new-template"></a>Упражнение 7: Краткая информация о новый шаблон ASP.NET MVC 4
...
6. Теперь имеется возможность просматривать решения и некоторые новые функции ASP.NET MVC 4 в шаблоне проекта.
   ...
   2. **Включены библиотеки JavaScript**
      ...
      2. **пользовательский Интерфейс jQuery**: Эта библиотека предоставляет абстракции для взаимодействия низкого уровня, а также анимации, расширенные эффекты и мини-приложения могут изменяться темами, созданная на основе библиотеку JavaScript jQuery.
