...
[Загрузите комплект учебных материалов лагеря Web](http://www.microsoft.com/en-us/download/29843)
...
- Эмулятор Windows Phone (включен в [Windows Phone 7.1.1 SDK](https://www.microsoft.com/en-us/download/details.aspx?id=29233))
...
> **@mediaэкран и (минимальной ширины: 400 пикс) и (максимальная ширина: 700px) {...}:** только для экранов. Разрешение должно быть в диапазоне от 400 до 700px.
> 
> **@mediaпортативные и (минимальной ширины: 20em), экран и (минимальной ширины: 20em) {...}:** для карманных ПК (устройств и мобильных устройств) и экраны. Минимальная ширина должна быть больше 20em.
> 
...
4. Откройте **HomeController.cs** файл из **контроллеров** папки.
