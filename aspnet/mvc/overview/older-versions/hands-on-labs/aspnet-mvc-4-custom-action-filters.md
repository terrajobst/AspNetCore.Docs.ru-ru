...
2. Откройте **Global.asax** и найдите **приложения\_запустить** метод. Обратите внимание, что каждый thime приложение запускает его регистрация глобальных фильтров путем вызова **RegisterGlobalFilters** метода в **FilterConfig** класса.
