...
Страница индекса инструктора показано три разных таблиц. Таким образом вы создадите модель представления, которая включает три свойства каждого хранения данных для одной из таблиц.
