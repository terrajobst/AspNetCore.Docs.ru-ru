...
**Рис. 02**: создать диалоговое окно модульного теста ([Просмотр полноразмерного изображения](understanding-models-views-and-controllers-cs/_static/image4.png))
...
**Рис. 04**: диалоговое окно, отладка не включена ([Просмотр полноразмерного изображения](understanding-models-views-and-controllers-cs/_static/image8.png))
...
**05 рис**: на странице индекса ([Просмотр полноразмерного изображения](understanding-models-views-and-controllers-cs/_static/image11.png))
