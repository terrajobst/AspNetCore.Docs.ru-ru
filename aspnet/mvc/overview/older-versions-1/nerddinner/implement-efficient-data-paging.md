...
ms.locfileid: "37372453"
---
<a name="implement-efficient-data-paging"></a>Реализовать эффективный данных разбиение по страницам
====================
...
## <a name="nerddinner-step-8-paging-support"></a>NerdDinner шаг 8: Поддержка разбиения на страницы
