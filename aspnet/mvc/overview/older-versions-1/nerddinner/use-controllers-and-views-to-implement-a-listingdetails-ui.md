...
| --- | --- | --- | --- |
| */ Ужинов/сведения/2* | DinnersController | Details(ID) | идентификатор = 2 |
...
Например, мы работали в классе DinnersController —, который явно ссылается на три шаблоны представлений: «Индекс», «Подробности» и «NotFound». ASP.NET MVC по умолчанию ищет эти представления в *\Views\Dinners* каталог под наших корневой каталог приложения:
