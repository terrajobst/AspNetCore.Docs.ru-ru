...
title: Создание макетов страниц с главными страницами представлений (C#) | Документы Microsoft
author: microsoft
...
---
<a name="creating-page-layouts-with-view-master-pages-c"></a>Создание макетов страниц с главными страницами представлений (C#)
====================
...
**На рисунке 01**: Добавление главной страницы представления ([Просмотр полноразмерное изображение](creating-page-layouts-with-view-master-pages-cs/_static/image3.png))
...
**На рисунке 03**: Добавление страница содержимого представления ([Просмотр полноразмерное изображение](creating-page-layouts-with-view-master-pages-cs/_static/image9.png))
...
**На рисунке 04**: Выбор главной страницы ([Просмотр полноразмерное изображение](creating-page-layouts-with-view-master-pages-cs/_static/image12.png))
...
При запросе представления в списке 3 он отображает страницу на рис. 5. Обратите внимание, что представление отображает страницу с двумя столбцами. Обратите внимание на то, кроме того, что содержимое на странице содержимого объединяется с содержимым из главной страницы представления
...
**На рисунке 05**: индекс, представляющий страница содержимого представления ([Просмотр полноразмерное изображение](creating-page-layouts-with-view-master-pages-cs/_static/image15.png))
