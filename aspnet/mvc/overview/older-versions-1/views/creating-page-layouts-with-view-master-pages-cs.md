...
**05 рис**: страница содержимого представления индекс ([Просмотр полноразмерного изображения](creating-page-layouts-with-view-master-pages-cs/_static/image15.png))
