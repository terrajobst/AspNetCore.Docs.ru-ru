...
ms.locfileid: "37822248"
---
<a name="passing-data-to-view-master-pages-vb"></a>Передача данных на главные страницы представлений (VB)
====================
...
**Рис. 02**: Просмотр подробностей ([Просмотр полноразмерного изображения](passing-data-to-view-master-pages-vb/_static/image6.png))
