...
**В листинге 1 - Controllers\GroupControllerTest.vb**
...
**В листинге 6 - Controllers\GroupControllerTest.vb**
...
**Рис. 04**: указание связи между таблицами ([Просмотр полноразмерного изображения](iteration-6-use-test-driven-development-vb/_static/image8.png))
...
**Рис 07**: индекс группы представление ([Просмотр полноразмерного изображения](iteration-6-use-test-driven-development-vb/_static/image14.png))
