...
**Рис. 02**: страницу подтверждения удаления ([Просмотр полноразмерного изображения](iteration-7-add-ajax-functionality-cs/_static/image4.png))
