...
> [!WARNING]
> Текущей инструкции проверки подлинности Facebook OAuth2 см [проверки подлинности Facebook, Настройка](/aspnet/core/security/authentication/social/facebook-logins)
