...
- Стив Сандерсон post серии, включает в себя: 
    ...
    2. [Стандартное использование: типичные случаи использования и параметры](http://blog.stevensanderson.com/2011/01/13/mvcscaffolding-standard-usage/)
    ...
    6. [Этой записи: Создание настраиваемых средств формирования шаблонов](http://blog.stevensanderson.com/2011/04/07/mvcscaffolding-creating-custom-scaffolders/)
