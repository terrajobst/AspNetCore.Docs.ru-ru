...
ms.locfileid: "50090297"
---
<a name="introduction-to-signalr"></a>Введение в SignalR
====================

См. в разделе [введение в ASP.NET Core SignalR](/aspnet/core/signalr/introduction) обновленную версию этого учебника, который использует последнюю версию Visual Studio. Использует новое учебное [ASP.NET Core](/aspnet/core/), через этот учебник, который предоставляет множество улучшений.
