...
SignalR также позволяет полностью новые типы веб-приложений, требующих высокой частотой обновления с сервера, например, в режиме реального времени игры. Хороший пример этого см. [ShootR игры.](http://shootr.signalr.net/)
