...
**Добавление в проект Microsoft.Owin.Cors:** , установите эту библиотеку, выполните следующую команду в консоли диспетчера пакетов:
