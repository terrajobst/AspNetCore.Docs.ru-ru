...
- **Пул приложений QueueLength**: максимальное число запросов в очереди, Http.sys для пула приложений. Если очередь заполнена, новые запросы возвращается сообщение 503 «Служба недоступна». Значение по умолчанию — 1000.
    ...
    Сокращение длины очереди для рабочих процессов в пуле приложений, размещение приложения будет экономии ресурсов памяти. Дополнительные сведения см. в разделе [управление, помощник по настройке и Настройка групп приложений](https://technet.microsoft.com/en-us/library/cc745955.aspx).
