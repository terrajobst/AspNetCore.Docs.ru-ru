...
3. В **шаблоны** области **новый проект** под **Visual C#** выберите **Cloud** узел и выберите **Облачной службы azure** шаблона. Присвойте приложению имя **SignalRPerfCounters** и выберите **ОК**.
...
21. Создайте новую папку в **WebRole1** проект с именем *концентраторов*. Щелкните правой кнопкой мыши *концентраторов* папку в **обозревателе решений**выберите **Web** > **SignalR**и выберите  **Класс концентратора SignalR (v2)**. Назовите новый концентратор *MyHub.cs* и выберите **добавить**.
