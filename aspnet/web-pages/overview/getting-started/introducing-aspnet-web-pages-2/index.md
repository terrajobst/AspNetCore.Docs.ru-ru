...
---
<a name="introducing-aspnet-web-pages"></a>Общие сведения о веб-страницы ASP.NET
====================
...
- [Основы HTML-формы](form-basics.md)
- [Ввод данных базы данных с помощью форм](entering-data.md)
- [Обновление баз данных](updating-data.md)
- [Удаление базы данных](deleting-data.md)
- [Создание согласованного макета](layouts.md)
- [При публикации узла с помощью WebMatrix](publishing.md)
