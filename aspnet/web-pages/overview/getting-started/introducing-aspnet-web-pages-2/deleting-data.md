...
> Этого учебника показано, как удалить запись отдельной базы данных. Предполагается, что завершена ряда через [обновление базы данных в веб-страниц ASP.NET](updating-data.md).
> 
...
Этот учебник не будет подробно создание эту ссылку, так как он является практически идентичен **изменить** ссылку из предыдущего учебника ([обновление базы данных в веб-страниц ASP.NET](updating-data.md)).
