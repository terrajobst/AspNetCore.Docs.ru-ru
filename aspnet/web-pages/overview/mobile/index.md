...
====================
> Способы работы с мобильными устройствами в приложениях ASP.NET Web Pages.


- [Визуализации ASP.NET Web Pages сайты для мобильных устройств](rendering-aspnet-web-pages-sites-for-mobile-devices.md)
