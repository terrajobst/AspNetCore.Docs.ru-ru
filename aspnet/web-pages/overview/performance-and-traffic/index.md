...
====================
> Как для кэширования содержимого для повышения производительности, а также измерение трафика узла.
...
- [Объединение и Минификация активов на сайте ASP.NET Web Pages (Razor)](bundling-and-minifying-assets-in-an-aspnet-web-pages-razor-site.md)
