...
4. Теперь вы можете изучить структуру сгенерированное решение.
    ...
    *Изучение созданного решения*
    ...
    3. **Контроллеры** и **представления**: этих папок являются обязательными для **ASP.NET MVC** и **веб-API ASP.NET** компонентов. Рассмотрим в следующих упражнениях технологии MVC и веб-API.
...
<a id="Exercise3"></a>
### <a name="exercise-3-creating-a-web-api-controller-using-scaffolding"></a>Упражнение 3: Создание контроллер веб-API, с помощью формирования шаблонов
