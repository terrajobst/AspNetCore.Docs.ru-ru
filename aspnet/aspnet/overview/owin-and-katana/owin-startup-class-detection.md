...
2. Добавьте класс запуска OWIN. В Visual Studio 2013 правой кнопкой мыши проект и выберите **добавить класс**. — в **Добавление нового элемента** диалогового окна введите *OWIN* в поле поиска и измените имя на файле Startup.cs, затем **добавить**.  
