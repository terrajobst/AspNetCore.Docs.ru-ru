...
- [Выходные дни Scripter: Приступая к работе с Azure и PowerShell](http://blogs.technet.com/b/heyscriptingguy/archive/2013/06/22/weekend-scripter-getting-started-with-windows-azure-and-powershell.aspx). В блоге, посвященная Windows PowerShell этой записи обеспечивает вас отличным введением в использование PowerShell для работы функций управления Azure.
