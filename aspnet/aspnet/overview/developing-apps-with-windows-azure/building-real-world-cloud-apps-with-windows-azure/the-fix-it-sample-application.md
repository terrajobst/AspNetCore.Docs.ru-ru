...
9. Создание веб-приложения для базового (очереди без обработки) решение приложения, выполните скрипт создания среды.
    ...
    Если скрипт вызывает сбой или ошибок, таких как «New-AzureWebsite: вызов Set-AzureSubscription и Select-AzureSubscription во-первых,» может не завершена конфигурации Azure PowerShell.
...
### <a name="internalerror-the-server-encountered-an-internal-error"></a>Внутренняя ошибка: Сервер обнаружил внутреннюю ошибку.
