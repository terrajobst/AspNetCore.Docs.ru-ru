...
- [Системы управления версиями следует использовать: TFVC или Git?](https://msdn.microsoft.com/en-us/library/vstudio/ms181368.aspx#tfvc_or_git_summary) Документация MSDN содержит таблицу суммирования различия между TFVC и Git.
...
- [Построение конвейера выпуска с Team Foundation Server 2012](https://msdn.microsoft.com/en-us/library/dn449957.aspx). Шаблоны и методики Майкрософт документации. В главе 6 сведения о стратегиях ветвления. Функция представителей переключает через компонент ветвей и при использовании ветвей для функции помощникам, обеспечивая кратковременных (часы или дни в большинстве случаев).
...
- [Разработки программного обеспечения с переключает функцию](https://msdn.microsoft.com/en-us/magazine/dn683796.aspx). В статье MSDN Magazine.
