...
- [Шаблоны и методики - руководство по Azure Майкрософт](https://msdn.microsoft.com/en-us/library/dn568099.aspx). См. руководство инструментирования и телеметрии, службы отслеживания использования инструкции, шаблон мониторинга работоспособности конечной точки и шаблон изменения конфигурации среды выполнения.
...
- [Советы и рекомендации по проектированию крупномасштабных служб в облачных службах Azure](https://msdn.microsoft.com/en-us/library/windowsazure/jj717232.aspx). Технический документ, Марк Симмс и Майкл Томасси. В разделе телеметрии и диагностики.
- [Разработка следующего поколения с помощью Application Insights](https://msdn.microsoft.com/en-us/magazine/dn683794.aspx). В статье MSDN Magazine.
