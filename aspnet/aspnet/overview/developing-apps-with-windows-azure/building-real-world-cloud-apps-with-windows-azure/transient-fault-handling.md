...
- [Построение Big: Уроках, извлеченных из клиентов Azure — часть II](https://channel9.msdn.com/Events/Build/2012/3-030). (Mark simms) рассказывает о разработке для сбоя, временные ошибки обработки и все, что инструментирование.
