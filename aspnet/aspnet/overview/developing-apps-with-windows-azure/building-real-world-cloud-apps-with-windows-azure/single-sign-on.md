...
Эти снимки экрана берутся полное Пошаговое руководство, где показано, как создать приложение, которое использует проверку подлинности Azure AD: [разработка приложений ASP.NET с Azure Active Directory](../../../../identity/overview/getting-started/developing-aspnet-apps-with-windows-azure-active-directory.md).
...
- [Практическое руководство: Установка средства Azure Active Directory Sync](https://social.technet.microsoft.com/wiki/contents/articles/19098.howto-install-the-windows-azure-active-directory-sync-tool-now-with-pictures.aspx).
