...
- Он имеет высокую степень масштабируемости. Можно хранить в одной учетной записи хранилища [сотни терабайт](https://msdn.microsoft.com/en-us/library/windowsazure/dn249410.aspx), и может иметь несколько учетных записей хранения. Некоторые из важнейших клиентам Azure хранить сотни петабайт. Microsoft SkyDrive использует хранилище больших двоичных объектов.
...
- [Шаблоны и методики - руководство по Azure Майкрософт](https://msdn.microsoft.com/en-us/library/dn568099.aspx). Шаблон ключа Valet см. в разделе.
