...
- [БАЗОВЫЙ: Acid альтернативы](http://queue.acm.org/detail.cfm?id=1394128). Статьи о компромиссы между согласованностью данных и масштабируемости.
...
- [Hadoop и HDInsight: больших данных в Azure](https://msdn.microsoft.com/magazine/dn385705.aspx). Статья журнала MSDN Magazine, Бруно Теркали и Рикардо Виллалобос, знакомство с Hadoop в Azure.
