...
VSTS предоставляет ряд функций для упрощения разработки приложений, от планирования до развертывания.
...
Дополнительные сведения о непрерывной интеграции и доставки возможностей VSTS см. в разделе [Visual Studio Team Services](https://www.visualstudio.com/team-services/).

Если вы ищете готовое управление проектами, совместной работы и решение для управления версиями, извлечение VSTS. Эта служба предоставляется бесплатно для 5 пользователей, и вы можете зарегистрироваться для ее на сайте [Visual Studio Team Services](https://www.visualstudio.com/team-services/).
