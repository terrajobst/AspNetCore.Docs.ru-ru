...
ms.locfileid: "30078157"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="dcf55-102">jQuery шаблоны бета-версия 1</span><span class="sxs-lookup"><span data-stu-id="dcf55-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="dcf55-103">Шаблоны jQuery подключаемый модуль включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="dcf55-103">The jQuery Templates plugin includes the following files:</span></span>
