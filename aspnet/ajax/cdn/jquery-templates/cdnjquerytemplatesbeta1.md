...
ms.locfileid: "37830177"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="950ac-102">jQuery шаблоны бета-версии 1</span><span class="sxs-lookup"><span data-stu-id="950ac-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="950ac-103">Подключаемый модуль jQuery шаблонов включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="950ac-103">The jQuery Templates plugin includes the following files:</span></span>
