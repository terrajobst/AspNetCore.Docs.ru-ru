...
ms.locfileid: "41828679"
---
<a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="ed96f-102">Веб-форм ASP.NET и Ajax 4</span><span class="sxs-lookup"><span data-stu-id="ed96f-102">ASP.NET Web Forms and Ajax 4</span></span>
====================
<span data-ttu-id="ed96f-103">Следующие файлы размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ed96f-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="ed96f-104">Примечание: Сценарии глобализации, например, fr-FR.js, можно найти в следующей папке:</span><span class="sxs-lookup"><span data-stu-id="ed96f-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
