...
ms.locfileid: "37815474"
---
<a name="jquery-validation-1120"></a><span data-ttu-id="67573-102">jQuery 1.12.0 проверки</span><span class="sxs-lookup"><span data-stu-id="67573-102">jQuery Validation 1.12.0</span></span>
====================
<span data-ttu-id="67573-103">Следующие файлы размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="67573-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="67573-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js где ## — loc код.</span><span class="sxs-lookup"><span data-stu-id="67573-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js where ## is the loc code.</span></span>
