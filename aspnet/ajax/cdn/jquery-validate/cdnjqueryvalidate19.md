...
ms.locfileid: "30070879"
---
<a name="jqueryvalidate-version-19"></a><span data-ttu-id="7bf46-102">jQuery.Validate версия 1.9</span><span class="sxs-lookup"><span data-stu-id="7bf46-102">jquery.validate version 1.9</span></span>
====================
<span data-ttu-id="7bf46-103">Следующие файлы размещаются в CDN:</span><span class="sxs-lookup"><span data-stu-id="7bf46-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="7bf46-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages \_## .js где ## loc код.</span><span class="sxs-lookup"><span data-stu-id="7bf46-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
