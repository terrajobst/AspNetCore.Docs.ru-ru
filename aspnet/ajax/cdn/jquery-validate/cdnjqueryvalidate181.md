...
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="97c3d-102">версия jQuery.Validate 1.8.1</span><span class="sxs-lookup"><span data-stu-id="97c3d-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="97c3d-103">Следующие файлы размещаются в CDN:</span><span class="sxs-lookup"><span data-stu-id="97c3d-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="97c3d-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages \_## .js где ## loc код.</span><span class="sxs-lookup"><span data-stu-id="97c3d-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
