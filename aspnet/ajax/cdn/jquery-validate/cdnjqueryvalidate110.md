...
ms.locfileid: "30071961"
---
<a name="jquery-validation-1100"></a><span data-ttu-id="943fe-102">jQuery проверки 1.10.0</span><span class="sxs-lookup"><span data-stu-id="943fe-102">jQuery Validation 1.10.0</span></span>
====================
<span data-ttu-id="943fe-103">Следующие файлы размещаются в CDN:</span><span class="sxs-lookup"><span data-stu-id="943fe-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="943fe-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages \_## .js где ## loc код.</span><span class="sxs-lookup"><span data-stu-id="943fe-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages\_##.js where ## is the loc code.</span></span>
