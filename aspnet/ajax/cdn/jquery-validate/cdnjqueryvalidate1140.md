...
ms.locfileid: "30070489"
---
<a name="jquery-validation-1140"></a><span data-ttu-id="9cd82-102">jQuery проверки 1.14.0</span><span class="sxs-lookup"><span data-stu-id="9cd82-102">jQuery Validation 1.14.0</span></span>
====================
<span data-ttu-id="9cd82-103">Следующие файлы размещаются в CDN:</span><span class="sxs-lookup"><span data-stu-id="9cd82-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="9cd82-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages \_## .js где ## loc код.</span><span class="sxs-lookup"><span data-stu-id="9cd82-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js where ## is the loc code.</span></span>
