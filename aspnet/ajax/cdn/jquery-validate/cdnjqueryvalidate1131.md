...
ms.locfileid: "30070931"
---
<a name="jquery-validation-1131"></a><span data-ttu-id="abebd-102">Проверка 1.13.1 jQuery</span><span class="sxs-lookup"><span data-stu-id="abebd-102">jQuery Validation 1.13.1</span></span>
====================
<span data-ttu-id="abebd-103">Следующие файлы размещаются в CDN:</span><span class="sxs-lookup"><span data-stu-id="abebd-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="abebd-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.1/localization/messages \_## .js где ## loc код.</span><span class="sxs-lookup"><span data-stu-id="abebd-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.1/localization/messages\_##.js where ## is the loc code.</span></span>
