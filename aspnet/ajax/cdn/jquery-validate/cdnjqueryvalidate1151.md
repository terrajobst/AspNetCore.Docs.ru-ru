...
---
<a name="jquery-validation-1151"></a><span data-ttu-id="64c15-102">jQuery проверки 1.15.1</span><span class="sxs-lookup"><span data-stu-id="64c15-102">jQuery Validation 1.15.1</span></span>
====================
<span data-ttu-id="64c15-103">Следующие файлы размещаются в CDN:</span><span class="sxs-lookup"><span data-stu-id="64c15-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="64c15-104">Файлы локализации https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages \_## .js где ## loc код.</span><span class="sxs-lookup"><span data-stu-id="64c15-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages\_##.js where ## is the loc code.</span></span>
