...
ms.locfileid: "30071198"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="5345a-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="5345a-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="5345a-103">Следующие файлы для jQuery DataTables подключаемые модули размещаются на CDN:</span><span class="sxs-lookup"><span data-stu-id="5345a-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
