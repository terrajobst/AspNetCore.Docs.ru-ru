...
ms.locfileid: "30071360"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="fb30c-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="fb30c-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="fb30c-103">Следующие файлы для jQuery DataTables подключаемые модули размещаются на CDN:</span><span class="sxs-lookup"><span data-stu-id="fb30c-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
