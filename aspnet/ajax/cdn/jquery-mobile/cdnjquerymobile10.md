...
ms.locfileid: "37365777"
---
<a name="jquery-mobile-10-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="cd8aa-102">jQuery Mobile 1.0 в сети доставки Содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="cd8aa-102">jQuery Mobile 1.0 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="cd8aa-103">Библиотека jQuery Mobile 1.0 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="cd8aa-103">The jQuery Mobile 1.0 library includes the following files:</span></span>
