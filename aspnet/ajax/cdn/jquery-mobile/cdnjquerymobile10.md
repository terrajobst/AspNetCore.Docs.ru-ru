...
ms.locfileid: "41829040"
---
<a name="jquery-mobile-10-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="3cd2f-102">jQuery Mobile 1.0 в сети доставки Содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="3cd2f-102">jQuery Mobile 1.0 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="3cd2f-103">Библиотека jQuery Mobile 1.0 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="3cd2f-103">The jQuery Mobile 1.0 library includes the following files:</span></span>
