...
ms.locfileid: "30070863"
---
<a name="jquery-mobile-141-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="c6876-102">jQuery Mobile 1.4.1 в сети Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="c6876-102">jQuery Mobile 1.4.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="c6876-103">Библиотеки jQuery Mobile 1.4.1 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="c6876-103">The jQuery Mobile 1.4.1 library includes the following files:</span></span>
