...
ms.locfileid: "30072905"
---
<a name="jquery-mobile-140-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="ff1f7-102">jQuery Mobile 1.4.0 в сети Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="ff1f7-102">jQuery Mobile 1.4.0 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="ff1f7-103">Библиотеки jQuery Mobile 1.4.0 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="ff1f7-103">The jQuery Mobile 1.4.0 library includes the following files:</span></span>
