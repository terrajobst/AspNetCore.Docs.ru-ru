...
ms.locfileid: "30072001"
---
<a name="jquery-mobile-142-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="c913b-102">jQuery Mobile 1.4.2 в сети Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="c913b-102">jQuery Mobile 1.4.2 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="c913b-103">Библиотеки jQuery Mobile 1.4.2 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="c913b-103">The jQuery Mobile 1.4.2 library includes the following files:</span></span>
