...
ms.locfileid: "37384856"
---
<a name="jquery-mobile-101-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="4025a-102">jQuery Mobile 1.0.1 в сети доставки Содержимого Microsoft Ajax</span><span class="sxs-lookup"><span data-stu-id="4025a-102">jQuery Mobile 1.0.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="4025a-103">Библиотека jQuery Mobile 1.0.1 включает следующие файлы:</span><span class="sxs-lookup"><span data-stu-id="4025a-103">The jQuery Mobile 1.0.1 library includes the following files:</span></span>
