...
<span data-ttu-id="ec1e5-113">**[Файлы в сети доставки Содержимого](#Third-Party_Files_on_the_CDN_23)**</span><span class="sxs-lookup"><span data-stu-id="ec1e5-113">**[Third-Party Files on the CDN](#Third-Party_Files_on_the_CDN_23)**</span></span>  
 ...
 [<span data-ttu-id="ec1e5-114">Выпусков jQuery в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-114">jQuery Releases on the CDN</span></span>](#jQuery_Releases_on_the_CDN_0)  
...
<span data-ttu-id="ec1e5-182">При перемещении фокуса в текстовое поле, с помощью клавиатуры, отображается календарь:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-182">When you move focus to the TextBox using your keyboard, a calendar is displayed:</span></span>
...
#### <a name="jquery-version-320"></a><span data-ttu-id="ec1e5-203">jQuery версии 3.2.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-203">jQuery version 3.2.0</span></span>
...
#### <a name="jquery-version-162"></a><span data-ttu-id="ec1e5-244">версия jQuery 1.6.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-244">jQuery version 1.6.2</span></span>
...
<span data-ttu-id="ec1e5-257">Следующие версии jQuery миграции размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-257">The following releases of jQuery Migrate are hosted on the CDN:</span></span>
...
- [<span data-ttu-id="ec1e5-286">пользовательский Интерфейс jQuery 1.8.20</span><span class="sxs-lookup"><span data-stu-id="ec1e5-286">jQuery UI 1.8.20</span></span>](jquery-ui/cdnjqueryui1820.md "пользовательский Интерфейс jQuery 1.8.20 в сети доставки Содержимого Microsoft Ajax")
...
- [<span data-ttu-id="ec1e5-341">jQuery Mobile 1.0 бета-версия 3</span><span class="sxs-lookup"><span data-stu-id="ec1e5-341">jQuery Mobile 1.0 beta 3</span></span>](jquery-mobile/cdnjquerymobile10b3.md "jQuery Mobile 1.0 бета-версии 3 в сети доставки Содержимого Microsoft Ajax")
...
<span data-ttu-id="ec1e5-353">В следующих выпусках подключаемый модуль jQuery DataTables размещаются в этой сети доставки Содержимого.</span><span class="sxs-lookup"><span data-stu-id="ec1e5-353">The following releases of the jQuery DataTables plugin are hosted on this CDN.</span></span> <span data-ttu-id="ec1e5-354">Щелкните каждый ссылку, чтобы просмотреть фактический список файлов.</span><span class="sxs-lookup"><span data-stu-id="ec1e5-354">Click each link to see the actual list of files.</span></span>

- [<span data-ttu-id="ec1e5-355">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="ec1e5-355">jQuery DataTables 1.10.5</span></span>](jquery-datatables/cdnjquerydatatables105.md "jQuery DataTables 1.10.5")
- [<span data-ttu-id="ec1e5-356">jQuery DataTables 1.10.4</span><span class="sxs-lookup"><span data-stu-id="ec1e5-356">jQuery DataTables 1.10.4</span></span>](jquery-datatables/cdnjquerydatatables104.md "jQuery DataTables 1.10.4")
- [<span data-ttu-id="ec1e5-357">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="ec1e5-357">jQuery DataTables 1.9.4</span></span>](jquery-datatables/cdnjquerydatatables194.md "jQuery DataTables 1.9.4")
- [<span data-ttu-id="ec1e5-358">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="ec1e5-358">jQuery DataTables 1.9.3</span></span>](jquery-datatables/cdnjquerydatatables193.md "jQuery DataTables 1.9.3")
- [<span data-ttu-id="ec1e5-359">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-359">jQuery DataTables 1.9.2</span></span>](jquery-datatables/cdnjquerydatatables192.md "jQuery DataTables 1.9.2")
- [<span data-ttu-id="ec1e5-360">jQuery DataTables 1.9.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-360">jQuery DataTables 1.9.1</span></span>](jquery-datatables/cdnjquerydatatables191.md "jQuery DataTables 1.9.1")
- [<span data-ttu-id="ec1e5-361">jQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-361">jQuery DataTables 1.9.0</span></span>](jquery-datatables/cdnjquerydatatables190.md "jQuery DataTables 1.9.0")
- [<span data-ttu-id="ec1e5-362">jQuery DataTables 1.8.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-362">jQuery DataTables 1.8.2</span></span>](jquery-datatables/cdnjquerydatatables182.md "jQuery DataTables 1.8.2")

<a id="Modernizr_Releases_on_the_CDN_8"></a>

### <a name="modernizr-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-363">Выпуски Modernizr в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-363">Modernizr Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-364">Следующие выпуски [Modernizr](http://www.modernizr.com "Modernizr") размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-364">The following releases of [Modernizr](http://www.modernizr.com "Modernizr") are hosted on the CDN:</span></span>
...
### <a name="jshint-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-365">Выпуски JSHint в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-365">JSHint Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-366">Следующие выпуски [JSHint](http://www.jshint.com "JSHint") размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-366">The following releases of [JSHint](http://www.jshint.com "JSHint") are hosted on the CDN:</span></span>

- https://ajax.aspnetcdn.com/ajax/jshint/r07/jshint.js

<a id="Knockout_Releases_on_the_CDN_11"></a>

### <a name="knockout-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-367">Выпуски Knockout в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-367">Knockout Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-368">Следующие выпуски [Knockout](http://www.knockoutjs.com "Knockout") размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-368">The following releases of [Knockout](http://www.knockoutjs.com "Knockout") are hosted on the CDN:</span></span>
...
### <a name="globalize-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-369">Глобализация выпусков в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-369">Globalize Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-370">Следующие выпуски [Globalize](https://github.com/jquery/globalize "Globalize") размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-370">The following releases of [Globalize](https://github.com/jquery/globalize "Globalize") are hosted on the CDN:</span></span>

#### <a name="globalize-version-100"></a><span data-ttu-id="ec1e5-371">Глобализация версии 1.0.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-371">Globalize version 1.0.0</span></span>
...
#### <a name="globalize-version-011"></a><span data-ttu-id="ec1e5-372">Глобализация версии 0.1.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-372">Globalize version 0.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.min.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.cultures.js

    - <span data-ttu-id="ec1e5-373">Все языки и региональные параметры</span><span class="sxs-lookup"><span data-stu-id="ec1e5-373">all cultures</span></span>
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.culture.{culture-code}.js

    - <span data-ttu-id="ec1e5-374">Замените «{языка и региональных параметров — код}» с кодом нужного языка и региональных параметров, например Microsoft globalize.culture.en GB.js== файлов в CDN == эти библиотеки были отправлены корпорацией Майкрософт.</span><span class="sxs-lookup"><span data-stu-id="ec1e5-374">Replace "{culture-code}" with the desired culture code, e.g. globalize.culture.en-GB.js== Microsoft Files on the CDN ==These libraries were uploaded by Microsoft.</span></span>

<a id="Respond_Releases_on_the_CDN_13"></a>

### <a name="respond-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-375">Ответ выпусков в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-375">Respond Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-376">Следующие выпуски [ https://github.com/scottjehl/Respond ] (https://github.com/scottjehl/Respond " https://github.com/scottjehl/Respond ") ответ размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-376">The following releases of [https://github.com/scottjehl/Respond](https://github.com/scottjehl/Respond "https://github.com/scottjehl/Respond") Respond are hosted on the CDN:</span></span>

#### <a name="respond-version-142"></a><span data-ttu-id="ec1e5-377">Ответ версии 1.4.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-377">Respond version 1.4.2</span></span>
...
#### <a name="respond-version-141"></a><span data-ttu-id="ec1e5-378">Ответ версии 1.4.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-378">Respond version 1.4.1</span></span>
...
#### <a name="respond-version-140"></a><span data-ttu-id="ec1e5-379">Ответ версии 1.4.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-379">Respond version 1.4.0</span></span>
...
#### <a name="respond-version-130"></a><span data-ttu-id="ec1e5-380">Ответ версии 1.3.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-380">Respond version 1.3.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.3.0/respond.js

#### <a name="respond-version-120"></a><span data-ttu-id="ec1e5-381">Ответ версии 1.2.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-381">Respond version 1.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.2.0/respond.js

<a id="Bootstrap_Releases_on_the_CDN_14"></a>

### <a name="bootstrap-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-382">Выпуски начальной загрузки в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-382">Bootstrap Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-383">Следующие выпуски [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-383">The following releases of [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap are hosted on the CDN:</span></span>

#### <a name="bootstrap-version-411"></a><span data-ttu-id="ec1e5-384">Начальной загрузки версии 4.1.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-384">Bootstrap version 4.1.1</span></span>
...
#### <a name="bootstrap-version-400"></a><span data-ttu-id="ec1e5-385">Начальной загрузки версии 4.0.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-385">Bootstrap version 4.0.0</span></span>
...
#### <a name="bootstrap-version-337"></a><span data-ttu-id="ec1e5-386">Начальной загрузки версии 3.3.7</span><span class="sxs-lookup"><span data-stu-id="ec1e5-386">Bootstrap version 3.3.7</span></span>
...
#### <a name="bootstrap-version-336"></a><span data-ttu-id="ec1e5-387">Начальной загрузки версии 3.3.6</span><span class="sxs-lookup"><span data-stu-id="ec1e5-387">Bootstrap version 3.3.6</span></span>
...
#### <a name="bootstrap-version-335"></a><span data-ttu-id="ec1e5-388">Начальной загрузки версии 3.3.5</span><span class="sxs-lookup"><span data-stu-id="ec1e5-388">Bootstrap version 3.3.5</span></span>
...
#### <a name="bootstrap-version-334"></a><span data-ttu-id="ec1e5-389">Начальной загрузки версии 3.3.4</span><span class="sxs-lookup"><span data-stu-id="ec1e5-389">Bootstrap version 3.3.4</span></span>
...
#### <a name="bootstrap-version-332"></a><span data-ttu-id="ec1e5-390">Начальной загрузки версии 3.3.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-390">Bootstrap version 3.3.2</span></span>
...
#### <a name="bootstrap-version-331"></a><span data-ttu-id="ec1e5-391">Начальной загрузки версии 3.3.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-391">Bootstrap version 3.3.1</span></span>
...
#### <a name="bootstrap-version-330"></a><span data-ttu-id="ec1e5-392">Начальной загрузки версии 3.3.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-392">Bootstrap version 3.3.0</span></span>
...
#### <a name="bootstrap-version-320"></a><span data-ttu-id="ec1e5-393">Начальной загрузки версии 3.2.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-393">Bootstrap version 3.2.0</span></span>
...
#### <a name="bootstrap-version-311"></a><span data-ttu-id="ec1e5-394">Начальной загрузки версии 3.1.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-394">Bootstrap version 3.1.1</span></span>
...
#### <a name="bootstrap-version-310"></a><span data-ttu-id="ec1e5-395">Начальной загрузки версии 3.1.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-395">Bootstrap version 3.1.0</span></span>
...
#### <a name="bootstrap-version-303"></a><span data-ttu-id="ec1e5-396">Начальной загрузки версии 3.0.3</span><span class="sxs-lookup"><span data-stu-id="ec1e5-396">Bootstrap version 3.0.3</span></span>
...
#### <a name="bootstrap-version-302"></a><span data-ttu-id="ec1e5-397">Начальной загрузки версии 3.0.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-397">Bootstrap version 3.0.2</span></span>
...
#### <a name="bootstrap-version-301"></a><span data-ttu-id="ec1e5-398">Начальной загрузки версии 3.0.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-398">Bootstrap version 3.0.1</span></span>
...
#### <a name="bootstrap-version-300"></a><span data-ttu-id="ec1e5-399">Начальной загрузки версии 3.0.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-399">Bootstrap version 3.0.0</span></span>
...
#### <a name="bootstrap-version-232"></a><span data-ttu-id="ec1e5-400">Начальной загрузки версии 2.3.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-400">Bootstrap version 2.3.2</span></span>
...
#### <a name="bootstrap-version-231"></a><span data-ttu-id="ec1e5-401">Начальной загрузки версии 2.3.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-401">Bootstrap version 2.3.1</span></span>
...
### <a name="bootstrap-touchcarousel-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-402">Выпуски TouchCarousel начальной загрузки в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-402">Bootstrap TouchCarousel Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-403">Следующие выпуски [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel выпуски размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-403">The following releases of [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel releases are hosted on the CDN:</span></span>

#### <a name="bootstrap-touchcarousel-version-080"></a><span data-ttu-id="ec1e5-404">TouchCarousel начальной загрузки версии 0.8.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-404">Bootstrap TouchCarousel version 0.8.0</span></span>
...
### <a name="hammerjs-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-405">Выпуски Hammer.js в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-405">Hammer.js Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-406">Следующие выпуски [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js выпуски размещаются в сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-406">The following releases of [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js releases are hosted on the CDN:</span></span>

#### <a name="hammerjs-version-204"></a><span data-ttu-id="ec1e5-407">Hammer.js версии 2.0.4</span><span class="sxs-lookup"><span data-stu-id="ec1e5-407">Hammer.js version 2.0.4</span></span>
...
### <a name="aspnet-web-forms-and-ajax-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-408">Веб-форм ASP.NET и Ajax выпусков в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-408">ASP.NET Web Forms and Ajax Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-409">Следующие версии ASP.NET Ajax Library размещаются в сети доставки Содержимого.</span><span class="sxs-lookup"><span data-stu-id="ec1e5-409">The following releases of the ASP.NET Ajax Library are hosted on the CDN.</span></span> <span data-ttu-id="ec1e5-410">Щелкните каждый ссылку, чтобы просмотреть фактический список файлов.</span><span class="sxs-lookup"><span data-stu-id="ec1e5-410">Click each link to see the actual list of files.</span></span>

- [<span data-ttu-id="ec1e5-411">Версии веб-форм ASP.NET и Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-411">ASP.NET Web Forms and Ajax version 4.5.2</span></span>](cdnajax452.md "веб-форм ASP.NET и Ajax 4.5.2")
- [<span data-ttu-id="ec1e5-412">Версии веб-форм ASP.NET и Ajax 4</span><span class="sxs-lookup"><span data-stu-id="ec1e5-412">ASP.NET Web Forms and Ajax version 4</span></span>](cdnajax4.md "веб-форм ASP.NET и Ajax 4")
- [<span data-ttu-id="ec1e5-413">Ajax для ASP.NET версии 3.5</span><span class="sxs-lookup"><span data-stu-id="ec1e5-413">ASP.NET Ajax version 3.5</span></span>](cdnajax35.md "Ajax для ASP.NET 3.5")

<a id="ASPNET_MVC_Releases_on_the_CDN_16"></a>

### <a name="aspnet-mvc-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-414">Освобождает ASP.NET MVC в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-414">ASP.NET MVC Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-415">Следующие файлы ASP.NET MVC JavaScript, размещенных в этой сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-415">The following ASP.NET MVC JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-mvc-523"></a><span data-ttu-id="ec1e5-416">ASP.NET MVC 5.2.3</span><span class="sxs-lookup"><span data-stu-id="ec1e5-416">ASP.NET MVC 5.2.3</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-51"></a><span data-ttu-id="ec1e5-417">ASP.NET MVC 5.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-417">ASP.NET MVC 5.1</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-50"></a><span data-ttu-id="ec1e5-418">ASP.NET MVC 5.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-418">ASP.NET MVC 5.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-40"></a><span data-ttu-id="ec1e5-419">ASP.NET MVC 4.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-419">ASP.NET MVC 4.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-30"></a><span data-ttu-id="ec1e5-420">ASP.NET MVC 3.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-420">ASP.NET MVC 3.0</span></span>
...
#### <a name="aspnet-mvc-20"></a><span data-ttu-id="ec1e5-421">ASP.NET MVC 2.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-421">ASP.NET MVC 2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.js
- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.debug.js

#### <a name="aspnet-mvc-10"></a><span data-ttu-id="ec1e5-422">ASP.NET MVC 1.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-422">ASP.NET MVC 1.0</span></span>
...
### <a name="aspnet-signalr-releases-on-the-cdn"></a><span data-ttu-id="ec1e5-423">Освобождает ASP.NET SignalR в сети доставки Содержимого</span><span class="sxs-lookup"><span data-stu-id="ec1e5-423">ASP.NET SignalR Releases on the CDN</span></span>

<span data-ttu-id="ec1e5-424">Следующие файлы ASP.NET SignalR JavaScript размещаются в этой сети доставки Содержимого:</span><span class="sxs-lookup"><span data-stu-id="ec1e5-424">The following ASP.NET SignalR JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-signalr-222"></a><span data-ttu-id="ec1e5-425">ASP.NET SignalR 2.2.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-425">ASP.NET SignalR 2.2.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.js

#### <a name="aspnet-signalr-221"></a><span data-ttu-id="ec1e5-426">ASP.NET SignalR 2.2.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-426">ASP.NET SignalR 2.2.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.js

#### <a name="aspnet-signalr-220"></a><span data-ttu-id="ec1e5-427">ASP.NET SignalR 2.2.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-427">ASP.NET SignalR 2.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.js

#### <a name="aspnet-signalr-210"></a><span data-ttu-id="ec1e5-428">ASP.NET SignalR 2.1.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-428">ASP.NET SignalR 2.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.js

#### <a name="aspnet-signalr-203"></a><span data-ttu-id="ec1e5-429">ASP.NET SignalR 2.0.3</span><span class="sxs-lookup"><span data-stu-id="ec1e5-429">ASP.NET SignalR 2.0.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.js

#### <a name="aspnet-signalr-202"></a><span data-ttu-id="ec1e5-430">ASP.NET SignalR 2.0.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-430">ASP.NET SignalR 2.0.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.js

#### <a name="aspnet-signalr-201"></a><span data-ttu-id="ec1e5-431">ASP.NET SignalR 2.0.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-431">ASP.NET SignalR 2.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.js

#### <a name="aspnet-signalr-200"></a><span data-ttu-id="ec1e5-432">ASP.NET SignalR 2.0.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-432">ASP.NET SignalR 2.0.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.js

#### <a name="aspnet-signalr-113"></a><span data-ttu-id="ec1e5-433">ASP.NET SignalR 1.1.3</span><span class="sxs-lookup"><span data-stu-id="ec1e5-433">ASP.NET SignalR 1.1.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.js

#### <a name="aspnet-signalr-112"></a><span data-ttu-id="ec1e5-434">ASP.NET SignalR 1.1.2</span><span class="sxs-lookup"><span data-stu-id="ec1e5-434">ASP.NET SignalR 1.1.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.js

#### <a name="aspnet-signalr-111"></a><span data-ttu-id="ec1e5-435">ASP.NET SignalR 1.1.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-435">ASP.NET SignalR 1.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.js

#### <a name="aspnet-signalr-110"></a><span data-ttu-id="ec1e5-436">ASP.NET SignalR 1.1.0</span><span class="sxs-lookup"><span data-stu-id="ec1e5-436">ASP.NET SignalR 1.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.js

#### <a name="aspnet-signalr-101"></a><span data-ttu-id="ec1e5-437">ASP.NET SignalR 1.0.1</span><span class="sxs-lookup"><span data-stu-id="ec1e5-437">ASP.NET SignalR 1.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.js

<span data-ttu-id="ec1e5-438">Сведения об условиях использования сети CDN, см. в разделе [Microsoft Ajax CDN условия использования](https://www.asp.net/terms-of-use "Microsoft Ajax CDN условия использования").</span><span class="sxs-lookup"><span data-stu-id="ec1e5-438">For information about the terms of use for the CDN, see [Microsoft Ajax CDN Terms of Use](https://www.asp.net/terms-of-use "Microsoft Ajax CDN Terms of Use").</span></span>
