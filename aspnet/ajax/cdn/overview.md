...
====================
Примечание: Сети Microsoft Ajax CDN есть кода с использованием Azure CDN не соглашения об уровне ОБСЛУЖИВАНИЯ.
...
- Старый формат: http://ajax.microsoft.com/ajax/jQuery/jquery-1.8.0.js
- Новый формат: http://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.8.0.js
...
- http://AJAX.aspnetcdn.com/AJAX/globalize/0.1.1/cultures/globalize.Culture. {язык и региональные параметры кода} .js
