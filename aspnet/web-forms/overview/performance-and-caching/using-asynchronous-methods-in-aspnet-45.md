...
- *WebAppAsync*: проекта веб-формы ASP.NET, использующего веб-API **WebAPIpwg** службы. Большая часть кода, для нашего руководства это из этого проекта.
