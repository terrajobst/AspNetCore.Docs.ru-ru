...
**Рис. 1**: возвращают сведения о продукте с помощью `GetProducts()` метод ([Просмотр полноразмерного изображения](handling-bll-and-dal-level-exceptions-vb/_static/image3.png))
...
**Рис. 2**: каждого продукта содержит кнопку "Изменить". ([Просмотр полноразмерного изображения](handling-bll-and-dal-level-exceptions-vb/_static/image6.png))
