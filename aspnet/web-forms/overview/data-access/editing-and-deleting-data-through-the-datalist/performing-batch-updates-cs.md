...
**Рис. 1**: изменить Each Item полностью редактирования элемента управления DataList ([Просмотр полноразмерного изображения](performing-batch-updates-cs/_static/image3.png))
...
**Рис. 3**: получение поставщика сведения с помощью `GetSuppliers()` метод ([Просмотр полноразмерного изображения](performing-batch-updates-cs/_static/image9.png))
