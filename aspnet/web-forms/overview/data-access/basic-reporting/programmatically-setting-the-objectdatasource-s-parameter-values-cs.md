...
**Рис. 1**: The ObjectDataSource `Selected` и `Selecting` вызывается метод ObjectDataSource возникают до и после нижележащего объекта ([Просмотр полноразмерного изображения](programmatically-setting-the-objectdatasource-s-parameter-values-cs/_static/image3.png))
...
**Рис. 2**: Добавление нового запроса к `EmployeesTableAdapter` ([Просмотр полноразмерного изображения](programmatically-setting-the-objectdatasource-s-parameter-values-cs/_static/image6.png))
...
**Рис. 3**: возвращает только те строки, у которых `HireDate` столбца меньше или равно `@HiredBeforeDate` параметра ([Просмотр полноразмерного изображения](programmatically-setting-the-objectdatasource-s-parameter-values-cs/_static/image9.png))
...
**Рис. 6**: использование `EmployeesBLL` класс ([Просмотр полноразмерного изображения](programmatically-setting-the-objectdatasource-s-parameter-values-cs/_static/image18.png))
...
**Рис. 8**: оставьте параметру источника значение None ([Просмотр полноразмерного изображения](programmatically-setting-the-objectdatasource-s-parameter-values-cs/_static/image24.png))
...
**Рис. 10**: те, сотрудники которых годовщины этот месяц отображаются ([Просмотр полноразмерного изображения](programmatically-setting-the-objectdatasource-s-parameter-values-cs/_static/image28.png))
