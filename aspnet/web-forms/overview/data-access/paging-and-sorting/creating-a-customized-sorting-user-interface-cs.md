...
## <a name="step-1-creating-a-standard-sortable-gridview"></a>Шаг 1: Создание стандартной страницы и сортировки GridView
...
**Рис. 2**: s поддерживает сортировку GridView отсортированы по категории ([Просмотр полноразмерного изображения](creating-a-customized-sorting-user-interface-cs/_static/image6.png))
