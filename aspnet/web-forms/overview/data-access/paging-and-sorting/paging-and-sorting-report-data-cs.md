...
**Рис. 8**: С включено разбиение на страницы, отображаются только подмножество записей за раз ([Просмотр полноразмерного изображения](paging-and-sorting-report-data-cs/_static/image14.png))
