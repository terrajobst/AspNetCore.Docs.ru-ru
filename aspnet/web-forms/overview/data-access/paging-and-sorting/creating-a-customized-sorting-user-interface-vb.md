...
**Рис. 2**: s поддерживает сортировку GridView отсортированы по категории ([Просмотр полноразмерного изображения](creating-a-customized-sorting-user-interface-vb/_static/image6.png))
