...
ms.locfileid: "37382683"
---
<a name="efficiently-paging-through-large-amounts-of-data-vb"></a>Эффективное разбиение больших объемов данных (VB)
====================
...
## <a name="step-1-understanding-the-custom-paging-process"></a>Шаг 1: Основные сведения о пользовательских разбиении по страницам
...
## <a name="step-2-returning-the-total-number-of-records-being-paged-through"></a>Шаг 2: Возвращение общее число записей, разбиваемых по страницам
...
**Рис. 4**: имя TotalNumberOfProducts DAL метод
...
**Рис. 5**: номера цен лежат включается для каждой записи возвращаются
...
**Рис. 17**: Data, упорядоченный по продукту — имя, является, разбитых на страницы с помощью пользовательского разбиения по страницам ([Просмотр полноразмерного изображения](efficiently-paging-through-large-amounts-of-data-vb/_static/image21.png))
...
**Рис. 18**: сортируется только отображаются данные на текущей странице ([Просмотр полноразмерного изображения](efficiently-paging-through-large-amounts-of-data-vb/_static/image24.png))
