...
**Рис. 3**: решили использовать существующую хранимую процедуру
...
## <a name="step-3-configuring-the-objectdatasource-to-pass-in-the-sortexpression-parameter"></a>Шаг 3: Настройка ObjectDataSource для передачи параметра SortExpression
