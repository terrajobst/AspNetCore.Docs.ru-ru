...
ms.locfileid: "37810819"
---
<a name="master-pages-and-site-navigation-vb"></a>Главные страницы и структуру переходов узла (VB)
====================
...
**Рис. 1**: конечный результат из этот учебник ([Просмотр полноразмерного изображения](master-pages-and-site-navigation-vb/_static/image3.png))
...
**Рис. 4**: главной страницы, при просмотре через режим конструктора ([Просмотр полноразмерного изображения](master-pages-and-site-navigation-vb/_static/image10.png))
...
**Рис. 13**: Добавление нового пользователя веб-элемента управления к `UserControls` папку ([Просмотр полноразмерного изображения](master-pages-and-site-navigation-vb/_static/image31.png))
...
**Рис. 14**: пользовательскому элементу управления был добавлен `Default.aspx` ([Просмотр полноразмерного изображения](master-pages-and-site-navigation-vb/_static/image34.png))
...
**Рис. 15**: руководст по созданию основных перечислены ([Просмотр полноразмерного изображения](master-pages-and-site-navigation-vb/_static/image37.png))
