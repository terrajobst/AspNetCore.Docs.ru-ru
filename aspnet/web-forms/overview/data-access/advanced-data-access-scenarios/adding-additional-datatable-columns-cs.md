...
**Рис. 1**: добавьте новый столбец для `ProductsDataTable` ([Просмотр полноразмерного изображения](adding-additional-datatable-columns-cs/_static/image3.png))
...
**Рис. 6**: имя s методы адаптера таблицы и нажмите "Готово" ([Просмотр полноразмерного изображения](adding-additional-datatable-columns-cs/_static/image18.png))
...
**Рис. 10**: получить сведения о продукте из `GetProductsWithPriceQuartile` метод ([Просмотр полноразмерного изображения](adding-additional-datatable-columns-cs/_static/image28.png))
...
**Рис. 11**: продукты упорядочены по их цены ([Просмотр полноразмерного изображения](adding-additional-datatable-columns-cs/_static/image31.png))
