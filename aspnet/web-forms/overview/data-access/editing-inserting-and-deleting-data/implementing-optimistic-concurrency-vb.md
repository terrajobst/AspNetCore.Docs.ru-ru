...
**Рис. 2**: For Update или Delete, чтобы добиться успеха, исходные значения должен быть равным текущие значения базы данных ([Просмотр полноразмерного изображения](implementing-optimistic-concurrency-vb/_static/image6.png))
...
**Рис. 3**: подключение к одной и той же базе данных "Борей" ([Просмотр полноразмерного изображения](implementing-optimistic-concurrency-vb/_static/image9.png))
...
**Рис. 10**: добавление `WHERE` предложение в Pre-Loaded запрос для возврата определенной записи продукта ([Просмотр полноразмерного изображения](implementing-optimistic-concurrency-vb/_static/image30.png))
...
**Рис. 11**: переименовать методы, которые `FillByProductID` и `GetProductByProductID` ([Просмотр полноразмерного изображения](implementing-optimistic-concurrency-vb/_static/image33.png))
...
**Рис. 16**: элемент управления ObjectDataSource не может найти метод с входные параметры, он хочет отправить ([Просмотр полноразмерного изображения](implementing-optimistic-concurrency-vb/_static/image46.png))
...
**Рис. 17**: одновременного нарушения при обнаружении `DBConcurrencyException` возникает исключение ([Просмотр полноразмерного изображения](implementing-optimistic-concurrency-vb/_static/image49.png))
...
**Рис. 19**: s пользователя, теряются обновлений в условиях возникновения одновременного нарушения ([Просмотр полноразмерного изображения](implementing-optimistic-concurrency-vb/_static/image55.png))
...
**Рис. 20**: s пользователя на удаление отменен в следствие одновременного нарушения ([Просмотр полноразмерного изображения](implementing-optimistic-concurrency-vb/_static/image58.png))
