...
**Рис. 4**: задать раскрывающиеся списки в обновления, вставки и удаления вкладок (нет) ([Просмотр полноразмерного изображения](adding-a-gridview-column-of-checkboxes-cs/_static/image8.png))
...
**Рис. 5**: указаны имя, категорию и цену первых десяти продуктов ([Просмотр полноразмерного изображения](adding-a-gridview-column-of-checkboxes-cs/_static/image10.png))
...
**Рис. 8**: при удалить выбранные продукты кнопки продукты выбранного `ProductID` перечислены ([Просмотр полноразмерного изображения](adding-a-gridview-column-of-checkboxes-cs/_static/image16.png))
