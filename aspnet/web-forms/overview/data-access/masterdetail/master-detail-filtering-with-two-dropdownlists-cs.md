...
**Рис. 11**: укажите используемые поля источника данных для элемента управления DropDownList `ListItem` s " `Text` и `Value` свойства ([Просмотр полноразмерного изображения](master-detail-filtering-with-two-dropdownlists-cs/_static/image33.png))
...
**Рис. 12**: выбран при первом просмотре страницы, категории «Напитки» ([Просмотр полноразмерного изображения](master-detail-filtering-with-two-dropdownlists-cs/_static/image36.png))
...
**Рис. 18**: выбранные сведения о продукте отображаются в элементе управления DetailsView ([Просмотр полноразмерного изображения](master-detail-filtering-with-two-dropdownlists-cs/_static/image54.png))
