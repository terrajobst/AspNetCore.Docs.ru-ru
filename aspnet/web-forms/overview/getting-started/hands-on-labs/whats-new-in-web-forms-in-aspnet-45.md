...
7. Запустите приложение и попробуйте передать изображение для продукта. Например можно использовать следующий URL-адрес изображения из искусство отсечения Microsoft Office: [[http://officeimg.vo.msecnd.net/images/MB900437099.jpg](http://officeimg.vo.msecnd.net/images/MB900437099.jpg)](http://officeimg.vo.msecnd.net/images/MB900437099.jpg)
