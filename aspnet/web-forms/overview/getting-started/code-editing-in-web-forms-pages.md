...
---
<a name="code-editing-aspnet-web-forms-in-visual-studio-2013"></a>Код редактирования веб-формы ASP.NET в Visual Studio 2013
====================
...
- [Microsoft Visual Studio 2013](https://www.microsoft.com/visualstudio/11/downloads#vs) или [Microsoft Visual Studio Express 2013 для Web](https://www.microsoft.com/visualstudio/11/downloads#express-web). Платформа .NET Framework устанавливается автоматически. 
  ...
  Введение в Visual Studio и ASP.NET, см. в разделе [Создание основные страницы веб-форм ASP.NET 4.5 в Visual Studio 2013](creating-a-basic-web-forms-page.md).   
