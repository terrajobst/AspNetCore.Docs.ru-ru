...
## <a name="step-3-examining-the-roles-api"></a>Шаг 3: Проверка роли API
...
**Рис. 6**: руководители роль имеет были добавлены ([Просмотр полноразмерного изображения](creating-and-managing-roles-cs/_static/image18.png))
