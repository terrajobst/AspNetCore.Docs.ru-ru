...
**Рис. 2**: добавить основной столбец с именем `CommentId` ([Просмотр полноразмерного изображения](storing-additional-user-information-vb/_static/image6.png))
...
**Рис. 3**: внешнего ключа связи диалоговое окно используется для управления ограничения внешнего ключа таблицы ([Просмотр полноразмерного изображения](storing-additional-user-information-vb/_static/image9.png))
...
**Рис. 5**: Настройка ограничение внешнего ключа для каскадные удаления ([Просмотр полноразмерного изображения](storing-additional-user-information-vb/_static/image15.png))
...
**Рис. 9**: перенести обратно все столбцы из `UserProfiles` таблицы ([Просмотр полноразмерного изображения](storing-additional-user-information-vb/_static/image27.png))
...
**Рис. 12**: запись была добавлена к `UserProfiles` для Брюс ([Просмотр полноразмерного изображения](storing-additional-user-information-vb/_static/image36.png))
...
**Рис. 13**: в настоящее время посещения пользователя — это показано His параметры ([Просмотр полноразмерного изображения](storing-additional-user-information-vb/_static/image39.png))
...
**Рис. 20**: новой учетной записи пользователя и `UserProfiles` записи были добавлены ([Просмотр полноразмерного изображения](storing-additional-user-information-vb/_static/image60.png))
...
**Рис. 21**: The CreateUserWizard рабочего процесса при дополнительных `WizardStep` Precedes `CreateUserWizardStep` ([Просмотр полноразмерного изображения](storing-additional-user-information-vb/_static/image63.png))
...
**Рис. 22**: The CreateUserWizard рабочего процесса при дополнительных `WizardStep` поставляется после `CreateUserWizardStep` ([Просмотр полноразмерного изображения](storing-additional-user-information-vb/_static/image66.png))
