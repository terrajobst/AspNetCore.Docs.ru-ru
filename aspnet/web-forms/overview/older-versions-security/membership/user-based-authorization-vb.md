...
ms.locfileid: "37834378"
---
<a name="user-based-authorization-vb"></a>Авторизации на основе пользователей (VB)
====================
...
**Рис. 1**: проверки подлинности форм и рабочий процесс авторизации URL-адрес ([Просмотр полноразмерного изображения](user-based-authorization-vb/_static/image3.png))
...
## <a name="step-1-defining-url-authorization-rules-inwebconfig"></a>Шаг 1: Определение правила авторизации URL-адрес в`Web.config`
...
**Рис. 3**: добавление `Web.config` файл `Membership` папку ([Просмотр полноразмерного изображения](user-based-authorization-vb/_static/image9.png))
...
**Рис. 4**: Your приложения должны теперь содержат два `Web.config` файлов ([Просмотр полноразмерного изображения](user-based-authorization-vb/_static/image12.png))
...
**Рис. 5**: так как авторизация URL-адреса правила запретить анонимный доступ, мы перенаправляются на страницу входа ([Просмотр полноразмерного изображения](user-based-authorization-vb/_static/image15.png))
...
## <a name="step-3-limiting-functionality-based-on-the-currently-logged-in-user"></a>Шаг 3: Ограничение функций, на основе текущего вошедшего пользователя
...
**Рис. 9**: выберите Delete кнопки не фактически удаляет этот файл ([Просмотр полноразмерного изображения](user-based-authorization-vb/_static/image27.png))
...
**Рис. 10**: The LoginView элемент управления отображает только `FileContents` текстовое поле для Authenticated Users ([Просмотр полноразмерного изображения](user-based-authorization-vb/_static/image30.png))
