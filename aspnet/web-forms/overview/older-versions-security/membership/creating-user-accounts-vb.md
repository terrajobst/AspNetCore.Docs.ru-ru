...
Практически все текста, отображаемого в пользовательском интерфейсе управления CreateUserWizard по умолчанию можно настроить с помощью его множество свойств. Например, можно настроить имя пользователя, пароль, подтвердите пароль, электронной почты, контрольный вопрос и ответ на контрольный вопрос метки отображаются слева от текстовых полей с [ `UserNameLabelText` ](https://msdn.microsoft.com/library/system.web.ui.webcontrols.createuserwizard.usernamelabeltext.aspx), [ `PasswordLabelText` ](https://msdn.microsoft.com/library/system.web.ui.webcontrols.createuserwizard.passwordlabeltext.aspx), [ `ConfirmPasswordLabelText` ](https://msdn.microsoft.com/library/system.web.ui.webcontrols.createuserwizard.confirmpasswordlabeltext.aspx), [ `EmailLabelText` ](https://msdn.microsoft.com/library/system.web.ui.webcontrols.createuserwizard.emaillabeltext.aspx), [ `QuestionLabelText` ](https://msdn.microsoft.com/library/system.web.ui.webcontrols.createuserwizard.questionlabeltext.aspx), и [ `AnswerLabelText` ](https://msdn.microsoft.com/library/system.web.ui.webcontrols.createuserwizard.answerlabeltext.aspx) свойства, соответственно. Аналогичным образом, являются свойства для задания текста для кнопки создания пользователя и продолжить в `CreateUserWizardStep` и `CompleteWizardStep`, а также, как если эти кнопки отображаются как кнопок, элементов управления LinkButton и ImageButtons.
