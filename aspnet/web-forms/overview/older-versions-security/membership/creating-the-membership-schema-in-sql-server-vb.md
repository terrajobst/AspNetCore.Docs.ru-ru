...
**Рис. 7**: используйте, чтобы добавить схемы членства ASP.NET SQL Server создает программа установки мастер ([Просмотр полноразмерного изображения](creating-the-membership-schema-in-sql-server-vb/_static/image21.png))
...
**Рис. 8**: выберите Настройка SQL Server для параметра службы приложений ([Просмотр полноразмерного изображения](creating-the-membership-schema-in-sql-server-vb/_static/image24.png))
...
**Рис. 10**: различные из таблицы, представления и хранимые процедуры были добавлены в базу данных ([Просмотр полноразмерного изображения](creating-the-membership-schema-in-sql-server-vb/_static/image30.png))
...
## <a name="step-3-a-look-at-the-schemas-core-tables"></a>Шаг 3: Рассмотрим схемы основных таблиц
...
**Таблица 2**: членства и `SqlMembershipProvider` параметры конфигурации
