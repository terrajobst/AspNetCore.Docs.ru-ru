...
**Рис. 2**: добавить основной столбец с именем `CommentId` ([Просмотр полноразмерного изображения](storing-additional-user-information-cs/_static/image6.png))
...
**Рис. 3**: внешнего ключа связи диалоговое окно используется для управления ограничения внешнего ключа таблицы ([Просмотр полноразмерного изображения](storing-additional-user-information-cs/_static/image9.png))
...
**Рис. 5**: Настройка ограничение внешнего ключа для каскадные удаления ([Просмотр полноразмерного изображения](storing-additional-user-information-cs/_static/image15.png))
...
**Рис. 9**: перенести обратно все столбцы из `UserProfiles` таблицы ([Просмотр полноразмерного изображения](storing-additional-user-information-cs/_static/image27.png))
...
**Рис. 12**: запись была добавлена к `UserProfiles` для Брюс ([Просмотр полноразмерного изображения](storing-additional-user-information-cs/_static/image36.png))
...
**Рис. 13**: в настоящее время посещения пользователя — это показано His параметры ([Просмотр полноразмерного изображения](storing-additional-user-information-cs/_static/image39.png))
...
## <a name="step-3-allowing-the-user-to-edit-his-home-town-homepage-and-signature"></a>Шаг 3: Разрешение пользователю изменять его домашней города, домашней страницы и подписи
...
## <a name="step-6-customizing-the-createuserwizard-control-to-include-an-interface-for-the-home-town-homepage-and-signature"></a>Шаг 6: Настройка элемента управления CreateUserWizard, чтобы включить интерфейс для домашней города, домашней страницы и подпись
...
**Рис. 20**: новой учетной записи пользователя и `UserProfiles` записи были добавлены ([Просмотр полноразмерного изображения](storing-additional-user-information-cs/_static/image60.png))
...
**Рис. 21**: The CreateUserWizard рабочего процесса при дополнительных `WizardStep` Precedes `CreateUserWizardStep` ([Просмотр полноразмерного изображения](storing-additional-user-information-cs/_static/image63.png))
...
**Рис. 22**: The CreateUserWizard рабочего процесса при дополнительных `WizardStep` поставляется после `CreateUserWizardStep` ([Просмотр полноразмерного изображения](storing-additional-user-information-cs/_static/image66.png))
