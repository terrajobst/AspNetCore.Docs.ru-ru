...
ms.locfileid: "37823995"
---
<a name="user-based-authorization-c"></a>Авторизации на основе пользователей (C#)
====================
...
**Рис. 1**: проверки подлинности форм и рабочий процесс авторизации URL-адрес ([Просмотр полноразмерного изображения](user-based-authorization-cs/_static/image3.png))
...
**Рис. 3**: добавление `Web.config` файл `Membership` папку ([Просмотр полноразмерного изображения](user-based-authorization-cs/_static/image9.png))
...
**Рис. 4**: Your приложения должны теперь содержат два `Web.config` файлов ([Просмотр полноразмерного изображения](user-based-authorization-cs/_static/image12.png))
...
**Рис. 5**: так как авторизация URL-адреса правила запретить анонимный доступ, мы перенаправляются на страницу входа ([Просмотр полноразмерного изображения](user-based-authorization-cs/_static/image15.png))
...
**Рис. 9**: выберите Delete кнопки не фактически удаляет этот файл ([Просмотр полноразмерного изображения](user-based-authorization-cs/_static/image27.png))
...
**Рис. 10**: The LoginView элемент управления отображает только `FileContents` текстовое поле для Authenticated Users ([Просмотр полноразмерного изображения](user-based-authorization-cs/_static/image30.png))
