...
ms.locfileid: "37821408"
---
<a name="validating-user-credentials-against-the-membership-user-store-vb"></a>Проверка учетных данных пользователей Store пользователя членства (VB)
====================
...
**Рис. 1**: на странице входа интерфейса включает в себя два текстовых поля, CheckBoxList и кнопка ([Просмотр полноразмерного изображения](validating-user-credentials-against-the-membership-user-store-vb/_static/image3.png))
...
**Рис. 3**: Добавление на страницу элемент управления Login ([Просмотр полноразмерного изображения](validating-user-credentials-against-the-membership-user-store-vb/_static/image9.png))
...
**Рис. 4**: Добавление на страницу элемент управления Login ([Просмотр полноразмерного изображения](validating-user-credentials-against-the-membership-user-store-vb/_static/image12.png))
...
**Рис. 5**: элемент управления Login свойства значения определяют его внешний вид ([Просмотр полноразмерного изображения](validating-user-credentials-against-the-membership-user-store-vb/_static/image15.png))
...
## <a name="step-3-modifying-the-login-controls-authentication-logic"></a>Шаг 3: Изменение логики проверки подлинности имени входа элемента управления
...
## <a name="step-4-improving-the-login-controls-invalid-credentials-message"></a>Шаг 4: Улучшение сообщение недопустимые учетные данные входа элемента управления
