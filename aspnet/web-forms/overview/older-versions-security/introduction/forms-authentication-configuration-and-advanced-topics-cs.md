...
Строка, userDataString = string. Concat (companyName [i], "|", titleAtCompany[i]);
...
FormsAuthenticationTicket newTicket = новый FormsAuthenticationTicket (билет. Версии билета. Имя, запрос в службу. IssueDate, билета. Срок действия билета. IsPersistent, userDataString);
...
**Рис 07**: The GenericPrincipal заменяется CustomPrincipal в событии PostAuthenticationRequest ([Просмотр полноразмерного изображения](forms-authentication-configuration-and-advanced-topics-cs/_static/image21.png))
...
**Рис 08**: добавить файл Global.asax для веб-сайта ([Просмотр полноразмерного изображения](forms-authentication-configuration-and-advanced-topics-cs/_static/image24.png))
