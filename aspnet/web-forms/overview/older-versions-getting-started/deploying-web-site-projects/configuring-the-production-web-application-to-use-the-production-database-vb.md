...
ms.locfileid: "37371068"
---
<a name="configuring-the-production-web-application-to-use-the-production-database-vb"></a>Настройка веб-приложение для использования рабочей базы данных (VB)
====================
...
**Рис. 3**: The Data-Driven приложение — теперь доступны в рабочей среде! ([Просмотр полноразмерного изображения](configuring-the-production-web-application-to-use-the-production-database-vb/_static/image9.jpg))
