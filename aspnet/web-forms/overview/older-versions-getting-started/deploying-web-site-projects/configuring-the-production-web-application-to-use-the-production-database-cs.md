...
ms.locfileid: "37803020"
---
<a name="configuring-the-production-web-application-to-use-the-production-database-c"></a>Настройка веб-приложение для использования рабочей базы данных (C#)
====================
...
**Рис. 3**: The Data-Driven приложение — теперь доступны в рабочей среде! ([Просмотр полноразмерного изображения](configuring-the-production-web-application-to-use-the-production-database-cs/_static/image9.jpg))
