...
ms.locfileid: "37380393"
---
<a name="determining-what-files-need-to-be-deployed-vb"></a>Определение того, что файлы должны быть развертыванию (VB)
====================
...
**Таблица 1: Развертывание файлов зависит от компиляции модели, используемой.**
...
**Рис. 1**: книги просматривает веб-сайт предлагает проверки на ассортимент заголовков ([Просмотр полноразмерного изображения](determining-what-files-need-to-be-deployed-vb/_static/image3.png))
