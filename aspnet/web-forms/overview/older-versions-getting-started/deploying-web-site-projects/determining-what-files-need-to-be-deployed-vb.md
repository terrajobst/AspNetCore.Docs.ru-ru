...
- [Общие сведения о компиляции в ASP.NET](https://msdn.microsoft.com/en-us/library/ms178466.aspx)
- [Пользовательские элементы управления ASP.NET](https://msdn.microsoft.com/en-us/library/y6wb1a0e.aspx)
- [Проверка ASP. В NET навигации веб-узла](http://aspnet.4guysfromrolla.com/articles/111605-1.aspx)
- [Введение в проекты веб-приложений](https://msdn.microsoft.com/en-us/library/aa730880.aspx)
...
- [Пошаговое руководство: Преобразование проекта веб-сайта в проект веб-приложения в Visual Studio](https://msdn.microsoft.com/en-us/library/aa983476.aspx)
