...
- [Практическое: предварительное создание представлений для повышения производительности запросов](https://msdn.microsoft.com/library/bb896240.aspx) веб-сайте MSDN. Содержит сведения об использовании `EdmGen.exe` средство командной строки, чтобы заранее создать представления.
