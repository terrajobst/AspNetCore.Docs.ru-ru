...
Дополнительные сведения о выполнении запросов, которые указываются в коде см. в разделе [как: непосредственно выполнение команды для источника данных](https://msdn.microsoft.com/library/ee358769.aspx).
...
Дополнительные сведения об использовании моделей в первую очередь платформы Entity Framework см. в разделе [моделей в первую очередь в Entity Framework 4](https://msdn.microsoft.com/data/ff830362.aspx).
...
- [Работа с сущностями POCO](https://msdn.microsoft.com/library/dd456853.aspx). Это документ MSDN, Обзор POCO, со ссылками на другие документы, которые более подробные сведения.
