...
**Рис 01**: главной страницы и страницы содержимого иерархии управления совмещенного вместе представляют собой во время этапа PreInit ([Просмотр полноразмерного изображения](specifying-the-master-page-programmatically-vb/_static/image3.png))
...
**Рис 06**: страницы содержимого, отображаются с помощью `Site.master` главной страницы ([Просмотр полноразмерного изображения](specifying-the-master-page-programmatically-vb/_static/image18.png))
...
**Рис 07**: содержимого страницы, теперь отображаются с помощью `Alternate.master` главной страницы ([Просмотр полноразмерного изображения](specifying-the-master-page-programmatically-vb/_static/image21.png))
