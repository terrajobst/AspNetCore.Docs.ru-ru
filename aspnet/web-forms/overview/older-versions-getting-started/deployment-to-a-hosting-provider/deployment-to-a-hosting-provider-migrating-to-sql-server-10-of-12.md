...
Если вы отправили *приложения\_offline.htm* перед публикацией, необходимо использовать **диспетчера файлов** служебной программы на панели управления Cytanium удалить *приложения\_вне сети.* htm, прежде чем тестировать. Можно также одновременно удалить *.sdf* файлов из *приложения\_данные* папки.
