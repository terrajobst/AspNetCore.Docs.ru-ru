...
Пакет SqlServerCompact NuGet предоставляет базе данных SQL Server Compact ядра сборок для приложения университета Contoso. Но теперь это не приложение, но веб-развертывания, который должен иметь возможность читать базы данных SQL Server Compact, чтобы создать скрипты для запуска в базах данных SQL Server. Чтобы включить веб-развертывание для чтения базы данных SQL Server Compact, установить SQL Server Compact на компьютере разработчика, используя следующую ссылку: [Microsoft SQL Server Compact 4.0](https://www.microsoft.com/downloads/details.aspx?FamilyID=15F7C9B3-A150-4AD2-823E-E4E0DCF85DF6).
