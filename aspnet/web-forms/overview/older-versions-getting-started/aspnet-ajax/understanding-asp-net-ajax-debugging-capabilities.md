...
> *>[!NOTE] при запуске в Windows Vista с пользователя Access Control (UAC) включена и у вас есть Visual Studio 2008, для запуска от имени администратора, Visual Studio не удастся присоединиться к процессу, когда вам будет предложено присоединить. Чтобы обойти эту проблему, сначала запустите Visual Studio и использовать его для отладки.*
