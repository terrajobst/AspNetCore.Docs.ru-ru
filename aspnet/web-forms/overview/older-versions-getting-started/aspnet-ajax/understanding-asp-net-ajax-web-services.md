...
**Рис. 3**: выходные данные создания вызова веб-служб, который возвращает данные RSS.  ([Просмотр полноразмерного изображения](understanding-asp-net-ajax-web-services/_static/image9.png))
