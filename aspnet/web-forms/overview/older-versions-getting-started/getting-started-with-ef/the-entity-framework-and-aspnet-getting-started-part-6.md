...
В предыдущем учебнике вы работали с взаимосвязанных данных путем добавления и удаления связей, а также посредством добавления новой сущности, имеющих отношение к существующей сущности. Этот учебник будет показано, как реализовать наследование в модели данных.
...
Откройте *SchoolModel.edmx* файл, щелкните правой кнопкой мыши незанятое область в конструкторе выберите **добавить**, а затем выберите **сущности***.*
