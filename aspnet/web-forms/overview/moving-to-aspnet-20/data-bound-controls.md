...
| --- | --- | --- |
| Отмена | «Отмена» | Используется в операциях обновления или вставки для отмены операции и отказаться от значений, введенных пользователем. Для режима, указанного в свойстве DefaultMode возвращает управления FormView. |
