...
## <a name="polling-based-sql-cache-dependenciesemalso-called-table-based-dependenciesem"></a>На основе опроса зависимости кэша SQL<em>(также называемые зависимости на основе таблиц)</em>
...
| **Attribute (XElement Dynamic Property)** (Attribute (динамическое свойство XElement)) | **Описание** |
| --- | --- |
| **enabled** | Требуется **логическое** атрибута. Указывает, будут ли изменения выполняется опрос на наличие. |
