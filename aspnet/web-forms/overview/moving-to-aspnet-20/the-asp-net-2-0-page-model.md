...
## <a name="addonprerendercompleteasync"></a>Метод AddOnPreRenderCompleteAsync
...
## <a name="step-2--call-getcallbackeventreference"></a>Шаг 2: Вызовите GetCallbackEventReference
...
## <a name="step-3--hook-the-client-side-control-event"></a>Шаг 3: Подключить событие клиентский элемент управления
