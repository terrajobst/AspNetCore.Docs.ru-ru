...
**Рис. 5**: Master с каждым элементом управления ContentPlaceHolder. Обратите внимание, что высота ячейки для ячейки заголовка теперь какой должна быть
...
**Рис. 7**: значение по умолчанию для содержимого страницы мастера элемент управления содержимым
