...
1. В режиме конструктора удалите элемент управления GridView из Default.aspx. 
    ...
    **Важные**: оставить на странице элемента управления SqlDataSource.
