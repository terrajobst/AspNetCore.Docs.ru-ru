...
**Рис. 2**: оповещение системы безопасности о SSL-сертификата
...
## <a name="lab-setup-ftp-site-and-create-a-project"></a>Лаборатории: Установка FTP сайта и создайте проект
...
7. Нажмите кнопку **откройте**. Расположение FTP вводится в диалоговое окно нового веб-сайта.
8. Нажмите кнопку **ОК**.
...
Чтобы открыть веб-проекта, выберите веб-сайт, откройте меню "файл". Вас попросят с то же диалоговое окно Выбор расположения, описанные ранее, и имеет те же четыре возможности, доступные пользователю: файловой системы, локальный сервер IIS, FTP и удаленный сайт.
...
**Рис. 9**: действие страницы запуска построения
...
**Рис. 12**: это уведомление, брандмауэр Windows блокирует удаленную отладку
