...
ms.locfileid: "37802037"
---
<a name="aspnet-web-deployment-using-visual-studio-setting-folder-permissions"></a>Веб-развертывание ASP.NET с помощью Visual Studio: параметр разрешения для папки
====================
