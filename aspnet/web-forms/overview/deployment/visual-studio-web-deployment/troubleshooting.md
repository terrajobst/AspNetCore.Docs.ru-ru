...
- [Монитор веб-приложений в службе приложений Azure](https://azure.microsoft.com/en-us/documentation/articles/web-sites-monitor//)
...
Сведения о том, как изменить элемент PreSource в файле проекта см. в разделе [как: изменение параметров развертывания в файле проекта](https://msdn.microsoft.com/en-us/library/ff398069(v=vs.100).aspx). Если пользователи или роли в базе данных разработки должны быть в целевой базе данных, обратитесь в службу поставщика услуг размещения для получения помощи.
...
Путь не является допустимым. Проверьте каталог для базы данных. [Путь = c:\inetpub\wwwroot\App\_Data\DatabaseName.sdf]
