...
System.Data.SqlClient.SqlException: Не удается открыть базу данных «DatabaseName», запрашиваемую именем входа. Сбой при входе.
...
Путь является недопустимым. Проверьте каталог для базы данных. [Путь = c:\inetpub\wwwroot\App\_Data\DatabaseName.sdf]
