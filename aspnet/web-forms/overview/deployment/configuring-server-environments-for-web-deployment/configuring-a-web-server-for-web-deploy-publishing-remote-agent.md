...
> [!NOTE]
> Дополнительные сведения о присоединении к домену компьютеров см. в разделе [присоединение компьютеров к домену и вход](https://technet.microsoft.com/en-us/library/cc725618(v=WS.10).aspx). Дополнительные сведения о настройке статических IP-адресов см. в разделе [настроить статический IP-адрес](https://technet.microsoft.com/en-us/library/cc754203(v=ws.10).aspx). Служба удаленного агента поддерживается начиная с IIS 6 и не требует присоединенных к домену. Тем не менее действия, описанные в этом учебнике, созданы и протестированы на IIS 7.5 и процедуры для других версий может отличаться.
