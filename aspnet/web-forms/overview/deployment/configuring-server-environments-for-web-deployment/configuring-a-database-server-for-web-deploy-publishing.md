...
> [!NOTE]
> Дополнительные сведения о присоединении к домену компьютеров см. в разделе [присоединение компьютеров к домену и вход](https://technet.microsoft.com/en-us/library/cc725618(v=WS.10).aspx). Дополнительные сведения о настройке статических IP-адресов см. в разделе [настроить статический IP-адрес](https://technet.microsoft.com/en-us/library/cc754203(v=ws.10).aspx). Дополнительные сведения об установке SQL Server см. в разделе [Установка SQL Server 2008 R2](https://technet.microsoft.com/en-us/library/bb500395.aspx).
...
2. В области представления дерева разверните **сетевая конфигурация SQL Server**, а затем нажмите кнопку **протоколы для MSSQLSERVER**.
    ...
    > [!NOTE]
    > Если установлено несколько экземпляров SQL Server, вы увидите **протоколы для***[имя экземпляра]* элемента для каждого экземпляра. Необходимо настроить параметры сети на основе по экземпляру.
...
> [!NOTE]
> Дополнительные сведения о серверных проектов и проектов баз данных см. в разделе [проекты базы данных Visual Studio 2010 SQL Server](https://msdn.microsoft.com/en-us/library/ff678491.aspx).
