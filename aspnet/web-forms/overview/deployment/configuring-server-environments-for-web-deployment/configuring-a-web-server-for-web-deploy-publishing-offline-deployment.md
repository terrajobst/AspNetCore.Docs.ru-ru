...
ms.locfileid: "37824678"
---
<a name="configuring-a-web-server-for-web-deploy-publishing-offline-deployment"></a>Настройка веб-сервера, для публикации (автономное развертывание) веб-развертывания
====================
