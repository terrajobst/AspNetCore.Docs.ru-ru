...
- [Практическое: Подготовка базы данных для развертывания из командной строки с помощью VSDBCMD. EXE-ФАЙЛА](https://msdn.microsoft.com/library/dd193258.aspx)
