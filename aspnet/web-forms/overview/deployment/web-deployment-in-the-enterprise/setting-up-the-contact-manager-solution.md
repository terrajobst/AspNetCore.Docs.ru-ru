...
> [!NOTE]
> Дополнительные сведения о aspnet\_regsql программы, в разделе [средство регистрации ASP.NET SQL Server (Aspnet\_regsql.exe)](https://msdn.microsoft.com/en-us/library/ms229862(v=vs.100).aspx).
