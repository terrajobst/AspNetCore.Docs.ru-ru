...
- Развертывание членства в роли базы данных в тестовой среде. После повторного создания базы данных на каждом развертывании & #x 2014; например, как часть построения непрерывной интеграции (CI) и развернуть в тестовой среде & #x 2014; как правило необходимо для настройки членства в роли базы данных каждый раз. Например обычно необходимо предоставить разрешения для удостоверения пула приложений, связанных с веб-приложения. В этом разделе описывается, как можно автоматизировать этот процесс, добавив после развертывания скрипт SQL логику развертывания.
