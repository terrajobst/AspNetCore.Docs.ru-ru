...
- Если вы используете развертывания «что, если»&#x2014;иными словами, если создание скриптов развертывания, но их фактически не выполняют&#x2014;не следует запустить сценарий SQL.
