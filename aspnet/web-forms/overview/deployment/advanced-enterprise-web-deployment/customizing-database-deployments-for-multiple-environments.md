...
- [Обзор параметров проекта базы данных](https://msdn.microsoft.com/en-us/library/aa833291(v=VS.100).aspx)
- [Как: Настройка свойств для сведений о развертывании](https://msdn.microsoft.com/en-us/library/dd172125.aspx)
- [Построение и развертывание баз данных в изолированной среде разработки](https://msdn.microsoft.com/en-us/library/dd193409.aspx)
- [Построение и развертывание баз данных в тестовой или производственной среде](https://msdn.microsoft.com/en-us/library/dd193413.aspx)
