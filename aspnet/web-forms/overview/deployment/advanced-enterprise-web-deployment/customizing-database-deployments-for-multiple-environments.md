...
|  | Разработки и тестирования | Промежуточного хранения и интеграции | Производство |
| --- | --- | --- | --- |
...
| **Блокировать добавочное развертывание при возможности потери данных** | False | Возможно | Да |
| **Выполнить скрипт развертывания в однопользовательском режиме** | False | True | Да |
| **Резервное копирование базы данных перед развертыванием** | False | Возможно | Да |
| **Создавать инструкции DROP для объектов, находящихся в целевую базу данных, но не входящие в проект базы данных** | False | True | Да |
...
- [Практическое: Настройка свойств для сведений о развертывании](https://msdn.microsoft.com/library/dd172125.aspx)
