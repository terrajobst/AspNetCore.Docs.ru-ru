...
В этом видео Joe приведены членства ASP.NET, показывая, как использовать некоторые элементы управления входа в ASP.NET.

[&#9654; Посмотрите видео (10 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/login-controls)
