...
====================
> В этом видео показано, новые возможности для элементов управления данными ASP.NET 4.


- [Выбор строк постоянные GridView](aspnet-4-quick-hit-persistent-gridview-row-selection.md)
