...
---
<a name="aspnet-4-quick-hit---imperative-webforms-routing"></a>В ASP.NET 4 «Быстрый Hit» - императивного WebForms маршрутизации
====================
по [(Joe Stagner)](https://github.com/JoeStagner)

В этом видео вы узнаете, как использовать построитель выражений для выполнения маршрутизации принудительно веб-форм. 

[&#9654;Посмотрите видео (12 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-imperative-webforms-routing)
