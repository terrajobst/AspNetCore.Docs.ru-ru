...
====================
> Этот набор видео показано, как создавать визуально привлекательные отображение данных с помощью элемента управления диаграммы для ASP.NET.


- [Элемент управления Chart](aspnet-4-quick-hit-chart-control.md)
- [Введение нового элемента управления диаграммы в Visual Studio 2010](aspnet-4-how-do-i-introducing-the-new-chart-control-in-visual-studio-2010.md)
