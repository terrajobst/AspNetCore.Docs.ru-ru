...
---
<a name="aspnet-4-quick-hit---jquery-syntax-for-microsoft-ajax"></a>В ASP.NET 4 «Быстрый попадания» - jQuery синтаксис Microsoft Ajax
====================
по [(Joe Stagner)](https://github.com/JoeStagner)

В этом видеоролике рассказывается о синтаксисе jQuery для Microsoft Ajax. 

[&#9654;Посмотрите видео (6 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-jquery-syntax-for-microsoft-ajax)
