...
Эта веб-трансляция рассматриваются сходства и различия между Создание веб-приложения в ASP.NET 2.0 и разрабатывать с помощью Java.

[&#9654; Посмотрите видео (в минутах 62)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/intro-to-aspnet-for-jsp-developers-building-applications)
