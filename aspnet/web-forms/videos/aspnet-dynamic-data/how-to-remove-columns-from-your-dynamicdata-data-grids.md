...
---
<a name="how-to-remove-columns-from-your-dynamicdata-data-grids"></a>Удаление столбцов из вашего таблицы DynamicData данных
====================
по [(Joe Stagner)](https://github.com/JoeStagner)

В этом видео вы увидите, как воспользоваться преимуществами полного столбца формирование шаблонов, но по-прежнему исключать столбцы таблицы, которые не должны отображаться в пользовательском интерфейсе.

[&#9654;Посмотрите видео (5 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-to-remove-columns-from-your-dynamicdata-data-grids)
