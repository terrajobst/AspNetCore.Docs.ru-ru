...
В этом видео я было показано, как создавать, обновлять и удалять записи с помощью LINQ, простых операций обновления через связи и пользовательской проверки столбцов и строк.

[&#9654;Посмотрите видео (17 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-linq-to-sql-updating-the-database)
