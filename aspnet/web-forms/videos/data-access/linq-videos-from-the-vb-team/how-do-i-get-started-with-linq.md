...
ms.locfileid: "30883116"
---
<a name="how-do-i-get-started-with-linq"></a>[Инструкции:] Начало работы с LINQ?
====================
по [Бет Масси](https://github.com/bethmassi)

Программисты на Visual Basic научитесь писать простые запросы LINQ объекты по навигации по файлам в файловой системе.

[&#9654;Посмотрите видео (9 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-get-started-with-linq)
