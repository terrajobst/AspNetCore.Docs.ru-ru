...
Дополнительные сведения о настройки инструментирования для покрытия кода и профилирования в развернутом приложении ASP.NET, а не в приложение, запущенное в среде Visual Studio. В этом видеоролике порядок действий в [профилирования ASP.NET в режиме инструментирования из командной строки](https://msdn.microsoft.com/teamsystem/aa718860.aspx) TechNote на сайте MSDN корпорации Майкрософт.
