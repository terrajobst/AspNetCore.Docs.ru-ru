...
Visual Studio Team System позволяет диаграммы изменяется в качества проекта кода по мере продвижения проекта. В этом видео приведены инструкции о том, как опубликовать результаты тестов в базе данных проекта Team Foundation Server и свяжите результаты с номером сборки. Мы видим, что после публикации результатов просматривать графическое представление изменения в наши тестовые результаты сборки можно использовать диспетчер отчетов.

[&#9654;Посмотрите видео (7 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-publish-and-analyze-test-results)
