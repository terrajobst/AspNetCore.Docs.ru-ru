...
---
<a name="how-do-i-get-started-with-the-entity-framework"></a>[Инструкции:] Начало работы с платформой Entity Framework
====================
по [Джеймс Алекс](https://github.com/adjames)

В этом видеоролике Джеймс Алекс Показать как создать простую модель данных сущности в течение короткого времени.

[&#9654; Посмотрите видео (9 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-get-started-with-the-entity-framework)
