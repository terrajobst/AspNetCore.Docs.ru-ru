...
---
<a name="implement-infinite-data-patterns-in-ajax"></a>Реализация шаблонов бесконечный данных в AJAX
====================
по [(Joe Stagner)](https://github.com/JoeStagner)

В этом видеоролике я покажу, как реализовать, что я называть шаблон бесконечный данных технологии AJAX.

[&#9654;Посмотрите видео (18 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/implement-infinite-data-patterns-in-ajax)
