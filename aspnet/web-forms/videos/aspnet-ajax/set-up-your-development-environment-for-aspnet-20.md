...
ms.locfileid: "30882927"
---
<a name="set-up-your-development-environment-for-aspnet-20"></a>Настройка среды разработки для ASP.NET 2.0
====================
по [(Joe Stagner)](https://github.com/JoeStagner)

В этом видео вы узнаете, как настроить среду разработки для разработки приложений AJAX ASP.NET при разработке проектов для ASP.NET 2.0.

[&#9654;Видео (15 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/set-up-your-development-environment-for-aspnet-20)
