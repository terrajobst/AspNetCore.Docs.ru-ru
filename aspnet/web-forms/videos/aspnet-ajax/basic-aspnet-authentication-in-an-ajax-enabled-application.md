...
---
<a name="basic-aspnet-authentication-in-an-ajax-enabled-application"></a>Приложения с поддержкой проверки подлинности Basic ASP.NET в AJAX
====================
по [(Joe Stagner)](https://github.com/JoeStagner)

В этом видео я продемонстрирую проверки подлинности с помощью базовых форм ASP.NET AJAX включить веб-приложения на основе проверки подлинности.

[&#9654;Посмотрите видео (31 мин.)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/basic-aspnet-authentication-in-an-ajax-enabled-application)
