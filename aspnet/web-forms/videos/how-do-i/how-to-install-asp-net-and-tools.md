...
Скотт Хансельман корпорации Майкрософт показано, как загрузить и установить ASP.NET и инструменты, чтобы вы могли начать разработку веб-приложений.

[&#9654; Посмотрите видео (3 минуты)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-to-install-asp-net-and-tools)
