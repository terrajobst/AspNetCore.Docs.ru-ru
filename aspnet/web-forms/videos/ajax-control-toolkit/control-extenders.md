...
---
<a name="control-extenders"></a>Расширения элемента управления
====================
по [(Joe Stagner)](https://github.com/JoeStagner)

Просмотрите это видео, чтобы понять разницу между элементами управления и расширителей элементов управления AJAX и как использовать эти расширения в приложениях.

[&#9654; Посмотрите видео (3 минуты)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/control-extenders)
