...
С расширитель перетаскиваемые панели ASP.NET AJAX можно предоставить область заголовка, которая позволяет пользователю перемещать панель вокруг веб-странице «содержимое».

[&#9654;Посмотрите видео (6 минут)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-use-the-aspnet-ajax-draggable-panel-extender)
