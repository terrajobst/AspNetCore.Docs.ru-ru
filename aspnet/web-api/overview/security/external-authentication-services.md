...
- Настройте сервер IIS Express использовать полное доменное имя для вашего приложения.
    ...
    3. Введите следующую команду, чтобы добавить полное доменное имя для приложения:
        ...
        <kbd>appcmd.exe установить настройки-section:system.applicationHost/sites / +&quot;[name = «WebApplication1»] .bindings. [ протокол = bindingInformation «http» = "*:80:www.wingtiptoys.com"]&quot; /commit:apphost</kbd>
