...
<span data-ttu-id="36c85-150">Вот, как клиент .NET может использовать формат BSON.</span><span class="sxs-lookup"><span data-stu-id="36c85-150">Here is how a .NET client can consume BSON format:</span></span>
