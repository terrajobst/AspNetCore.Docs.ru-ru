...
---
<a name="getting-started-with-aspnet-web-api-2-c"></a>Приступая к работе с ASP.NET Web API 2 (C#)
====================
...
Ну вот! У вас есть рабочий веб-API. Каждый метод в контроллере соответствует один или несколько URI-адресам:
...
- Сведения о развертывании веб-проекта Visual Studio для службы приложений Azure см. в разделе [создать веб-приложение ASP.NET в службе приложений Azure](https://azure.microsoft.com/en-us/documentation/articles/web-sites-dotnet-get-started/).
