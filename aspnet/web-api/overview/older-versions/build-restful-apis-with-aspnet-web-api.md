...
2. [Упражнение 2: Создание, чтение и запись веб-API](#Exercise2)
...
### <a name="exercise-2-create-a-readwrite-web-api"></a>Упражнение 2: Создание, чтение и запись веб-API
...
8. Нажмите клавишу **F5** для запуска проекта. Обозреватель загрузит HTML-документа.
...
> [!NOTE]
> Кроме того, можно развернуть это приложение для Azure следующих [приложение C: публикации приложения ASP.NET MVC 4 с помощью веб-развертывания](#AppendixC).
...
## <a name="appendix-c-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a>Приложение c. публикации приложения ASP.NET MVC 4 с помощью веб-развертывания
