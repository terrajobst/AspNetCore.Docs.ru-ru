...
---
<a name="create-an-odata-v4-endpoint-using-aspnet-web-api-22"></a>Создайте конечную точку OData версии 4 с помощью ASP.NET Web API 2.2
====================
...
В **новый проект** диалоговом окне выберите **пустой** шаблона. В разделе &quot;добавить папки и основные ссылки... &quot;, нажмите кнопку **веб-API**. Нажмите кнопку **ОК**.
...
## <a name="querying-the-entity-set"></a>Запрос набора сущностей
