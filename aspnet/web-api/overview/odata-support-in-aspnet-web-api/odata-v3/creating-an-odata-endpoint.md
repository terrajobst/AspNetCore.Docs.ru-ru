...
Примечание: Если вы получаете сообщение об ошибке, — говорит &quot;произошла ошибка при получении тип... &quot;, убедитесь, что вы создали проект Visual Studio после добавления к классу продукта. Формирование шаблонов использует отражение для поиска класса.
