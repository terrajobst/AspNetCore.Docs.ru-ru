...
<span data-ttu-id="30034-103">[Предыдущая статья — "Добавление модели"](adding-model.md)
[Следующая статья — "Методы и представления контроллера"](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="30034-103">[Previous - Add a model](adding-model.md)
